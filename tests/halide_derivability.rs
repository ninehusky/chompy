...
pub mod halide_derive_tests {
    ...
    #[tokio::test]
    async fn mul_div_workload() {
        let start_time = std::time::Instant::now();
        if std::env::var("RUN_ME").is_err() {
            return;
        }

        let wkld = get_condition_workload().await;
...
// (/ ?b (* ?b ?a)) ==> (/ ?a (* ?a ?a)) if (< 0 ?b)
// (* ?b (/ ?a ?a)) ==> ?b if (< 0 ?a)
// ("%" ("%" ?b ?a) ?b) ==> ("%" ("%" ?b ?b) ?a) if (== ("%" ?a ?b) 0)
// ("%" ("%" ?b ?b) ?a) ==> ("%" ("%" ?b ?a) ?b) if (== ("%" ?a ?b) 0)
// ("%" ("%" ?a ?b) ?a) ==> (* ?b ("%" ?a ?a)) if (== ("%" ?b ?a) 0)
// (* ?b ("%" ?a ?a)) ==> ("%" ("%" ?a ?b) ?a) if (== ("%" ?b ?a) 0)
// ("%" ("%" ?a ?b) ?a) ==> ("%" ?b ("%" ?a ?a)) if (== ("%" ?b ?a) 0)
// ("%" ?b ("%" ?a ?a)) ==> ("%" ("%" ?a ?b) ?a) if (== ("%" ?b ?a) 0)
// ("%" ("%" ?a ?b) ?a) ==> (/ ?b ("%" ?a ?a)) if (== ("%" ?b ?a) 0)
// (/ ?b ("%" ?a ?a)) ==> ("%" ("%" ?a ?b) ?a) if (== ("%" ?b ?a) 0)
// (/ ?b ("%" ?b ?a)) ==> (/ ("%" ?b ?a) ?b) if (== ("%" ?a ?b) 0)
// (/ ("%" ?b ?a) ?b) ==> (/ ?b ("%" ?b ?a)) if (== ("%" ?a ?b) 0)
// (* ?b (/ ?a ?a)) ==> (/ ?a (/ ?a ?b)) if (== ("%" ?a ?b) 0)
// (/ ?a (/ ?a ?b)) ==> (* ?b (/ ?a ?a)) if (== ("%" ?a ?b) 0)
// (/ ?a (/ ?b ?a)) ==> (/ (* ?a ?a) ?b) if (== ("%" ?b ?a) 0)
// (/ (* ?a ?a) ?b) ==> (/ ?a (/ ?b ?a)) if (== ("%" ?b ?a) 0)
// (* ?c (/ ?b ?a)) ==> (/ ?c (/ ?b ?a)) if (== ("%" ?a ?b) 0)
// (/ ?c (/ ?b ?a)) ==> (* ?c (/ ?b ?a)) if (== ("%" ?a ?b) 0)
// (* ?c (/ ?b ?a)) ==> (/ (* ?b ?c) ?a) if (== ("%" ?b ?a) 0)
// (/ (* ?b ?c) ?a) ==> (* ?c (/ ?b ?a)) if (== ("%" ?b ?a) 0)
// (/ ("%" ?c ?b) ?a) ==> (/ ?b ("%" ?a ?a)) if (== ("%" ?a ?b) 0)
// ("%" ?c (/ ?b ?a)) ==> 0 if (== ("%" ?a ?b) 0)
// (/ ("%" ?c ?b) ?a) ==> 0 if (== ("%" ?a ?b) 0)
// (/ ("%" ?a ?c) ?b) ==> ("%" 0 ?a) if (== ("%" ?b ?c) 0)
// ("%" ?c (/ ?b ?a)) ==> ("%" ?c 0) if (== ("%" ?a ?b) 0)
...
// ("%" ?a (/ ?c ?b)) ==> (* ?a 0) if (== ("%" ?b ?c) 0)
// ("%" ?c (/ ?a ?b)) ==> (/ ?a 0) if (== ("%" ?b ?a) 0)
// (/ ("%" ?c ?b) ?a) ==> ("%" ?a ("%" ?b ?a)) if (== ("%" ?a ?b) 0)
// (/ ("%" ?c ?b) ?a) ==> ("%" ?b ("%" ?b ?a)) if (== ("%" ?a ?b) 0)
// (/ ("%" ?c ?b) ?a) ==> ("%" ("%" ?b ?a) ?b) if (== ("%" ?a ?b) 0)
// ?a ==> (max ?a ?a)
// (max ?a ?a) ==> ?a
// ?a ==> (min ?a ?a)
// (min ?a ?a) ==> ?a
...
// (max ?a (min ?b ?a)) ==> ?a
// (min ?c (min ?b ?a)) ==> (min ?a (min ?b ?c))
// (min ?a (min ?b ?c)) ==> (min ?c (min ?b ?a))
// (max ?c (max ?b ?a)) ==> (max ?b (max ?c ?a))
// (max ?b (max ?c ?a)) ==> (max ?c (max ?b ?a))
// (max ?c (min ?b ?a)) ==> (min ?a (max ?c ?b)) if (<= ?c ?a)
// (min ?a (max ?c ?b)) ==> (max ?c (min ?b ?a)) if (<= ?c ?a)
...
// (min ?b (* ?b (min ?b ?a))) ==> (min ?b (* ?a (max ?b ?a)))
// (* ?b ?a) ==> (* (min ?b ?a) (max ?b ?a))
// (* (min ?b ?a) (max ?b ?a)) ==> (* ?b ?a)
// (* ?a (* ?a ?a)) ==> (max ?a (* ?a (* ?a ?a))) if (<= 0 ?a)
// (max ?a (* ?a (* ?a ?a))) ==> (* ?a (* ?a ?a)) if (<= 0 ?a)
// (min ?b (* ?b (min ?b ?a))) ==> (max ?b (* ?b (* ?b ?b))) if (<= ?b 0)
...
// (< (min ?b (+ ?b ?b)) (+ ?b ?a)) ==> (< (min ?a (+ ?b ?b)) (+ ?a ?a))
// (< ?b (+ ?b (min ?b ?a))) ==> (< (min ?a (+ ?b ?a)) (+ ?a (min ?b ?a)))
// (< (min ?a (+ ?b ?a)) (+ ?a (min ?b ?a))) ==> (< ?b (+ ?b (min ?b ?a)))
// (< (+ ?b (min ?a ?c)) (+ ?a (min ?a ?c))) ==> (< (+ ?b (+ ?b ?b)) (+ ?a (+ ?a ?a)))
// (< (+ ?c (+ ?b ?b)) (+ ?c (min ?b ?a))) ==> (< (+ ?c (+ ?b ?b)) (min ?c (+ ?c ?a)))
// (< (+ ?c (+ ?b ?b)) (min ?c (+ ?c ?a))) ==> (< (+ ?c (+ ?b ?b)) (+ ?c (min ?b ?a)))
// (< (+ ?b (min ?c ?a)) (+ ?b (+ ?a ?a))) ==> (< (min ?b (+ ?b ?c)) (+ ?b (+ ?a ?a)))
// (< (min ?b (+ ?b ?c)) (+ ?b (+ ?a ?a))) ==> (< (+ ?b (min ?c ?a)) (+ ?b (+ ?a ?a)))
// (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?a))) ==> (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?b)))
// (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?b))) ==> (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?a)))
// (< (+ ?a (min ?c ?b)) (+ ?b ?a)) ==> (< (min ?c (+ ?c ?c)) (min ?b (+ ?c ?b)))
// (< (+ ?a (min ?c ?b)) (+ ?b ?a)) ==> (< (min ?c (+ ?c ?c)) (min ?b (+ ?b ?b)))
// (< (+ ?a (min ?c ?b)) (+ ?b ?a)) ==> (< (+ ?c (+ ?c ?c)) (+ ?b (+ ?b ?b)))
// (< (min ?c ?b) (+ ?b (+ ?a ?a))) ==> (< (min ?c (+ ?b ?a)) (+ ?b (+ ?a ?a)))
// (< (min ?c (+ ?b ?a)) (+ ?b (+ ?a ?a))) ==> (< (min ?c ?b) (+ ?b (+ ?a ?a)))
// (< (+ ?c ?c) (+ ?b (min ?c ?a))) ==> (< (+ ?c (min ?c ?b)) (+ ?b (min ?b ?a)))
// (< (+ ?c (min ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (+ ?c ?c) (+ ?b (min ?c ?a)))
// (< (+ ?a (min ?c ?b)) (min ?a (+ ?b ?a))) ==> (< (+ ?c ?b) (min ?b (+ ?b ?b)))
// (< (+ ?b (+ ?a ?c)) (min ?c (+ ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (min ?b ?a))
// (< (+ ?c ?c) (min ?b (+ ?a ?a))) ==> (< (+ ?c (min ?c ?a)) (min ?b (+ ?a ?a)))
// (< (+ ?c (min ?c ?a)) (min ?b (+ ?a ?a))) ==> (< (+ ?c ?c) (min ?b (+ ?a ?a)))
// (< (+ ?b (+ ?a ?a)) (min ?b ?c)) ==> (< (+ ?b (+ ?a ?a)) (min ?c (+ ?b ?a)))
// (< (+ ?b (+ ?a ?a)) (min ?c (+ ?b ?a))) ==> (< (+ ?b (+ ?a ?a)) (min ?b ?c))
// (< (min ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (min ?c (+ ?b ?b)) (+ ?a (min ?b ?a)))
...
// (< (+ ?b ?b) (min ?c (+ ?a ?a))) ==> (< (+ ?b ?b) (min ?c (+ ?b ?a)))
// (< (+ ?c (min ?c ?b)) (+ ?a ?a)) ==> (< (+ ?c (min ?b ?a)) (+ ?a ?a))
// (< (+ ?c (min ?b ?a)) (+ ?a ?a)) ==> (< (+ ?c (min ?c ?b)) (+ ?a ?a))
// (< (min ?c (+ ?b ?a)) (+ ?a ?a)) ==> (< (min ?c (+ ?b ?b)) (+ ?a ?a))
// (< (min ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (min ?c (+ ?b ?a)) (+ ?a ?a))
// (< (+ ?c ?c) (+ ?a (min ?b ?a))) ==> (< (+ ?c ?c) (+ ?a (min ?c ?b)))
// (< (+ ?c ?c) (+ ?a (min ?c ?b))) ==> (< (+ ?c ?c) (+ ?a (min ?b ?a)))
// (< (+ ?c ?b) (+ ?b ?a)) ==> (< (+ ?b (+ ?c ?c)) (+ ?b (+ ?a ?a)))
// (< (+ ?b (+ ?c ?c)) (+ ?b (+ ?a ?a))) ==> (< (+ ?c ?b) (+ ?b ?a))
// (< (+ ?c ?b) (+ ?b ?a)) ==> (< (+ ?c (min ?c ?b)) (+ ?a (min ?b ?a)))
// (< (+ ?c (min ?c ?b)) (+ ?a (min ?b ?a))) ==> (< (+ ?c ?b) (+ ?b ?a))
// (< (+ ?b (+ ?a ?c)) (+ ?c (min ?b ?a))) ==> (< (+ ?b ?a) (min ?b ?a))
// (< (min ?b ?c) (+ ?b ?a)) ==> (< (min ?b (+ ?c ?a)) (+ ?b (+ ?a ?a)))
// (< (min ?b (+ ?c ?a)) (+ ?b (+ ?a ?a))) ==> (< (min ?b ?c) (+ ?b ?a))
// (< (+ ?c (min ?b ?a)) (+ ?b (+ ?a ?c))) ==> (< (min ?b ?a) (+ ?b ?a))
// (< (+ ?b ?c) (min ?c ?a)) ==> (< (+ ?c (+ ?b ?b)) (min ?c (+ ?b ?a)))
// (< (+ ?c (+ ?b ?b)) (min ?c (+ ?b ?a))) ==> (< (+ ?b ?c) (min ?c ?a))
// (< (+ ?c (min ?b ?a)) (+ ?a (+ ?a ?c))) ==> (< (min ?b ?a) (+ ?a ?a))
// (< (+ ?a (min ?c ?b)) (+ ?b ?a)) ==> (< (+ ?c ?c) (+ ?b ?b))
// (< (+ ?c (min ?a ?b)) (+ ?a ?c)) ==> (< (+ ?a ?b) (+ ?a ?a))
// (< (+ ?c ?b) (+ ?c (min ?b ?a))) ==> 0
// (< ?c (min ?c (min ?b ?a))) ==> 0
// (< (+ ?b (+ ?c ?d)) (+ ?c (+ ?b ?a))) ==> (< (+ ?d (min ?b ?c)) (+ ?a (min ?b ?c)))
// (< (+ ?d (min ?b ?c)) (+ ?a (min ?b ?c))) ==> (< (+ ?b (+ ?c ?d)) (+ ?c (+ ?b ?a)))
// (< (+ ?b ?d) (min ?c (+ ?b ?a))) ==> (< (+ ?b (min ?d ?a)) (min ?c (+ ?b ?a)))
// (< (+ ?b (min ?d ?a)) (min ?c (+ ?b ?a))) ==> (< (+ ?b ?d) (min ?c (+ ?b ?a)))
// (< (+ ?b ?d) (+ ?c (min ?b ?a))) ==> (< (+ ?b (min ?d ?c)) (+ ?c (min ?b ?a)))
// (< (+ ?b (min ?d ?c)) (+ ?c (min ?b ?a))) ==> (< (+ ?b ?d) (+ ?c (min ?b ?a)))
// (< (+ ?c ?d) (+ ?c (min ?b ?a))) ==> (< (+ ?c (min ?d ?b)) (+ ?c (min ?b ?a)))
// (< (+ ?c (min ?d ?b)) (+ ?c (min ?b ?a))) ==> (< (+ ?c ?d) (+ ?c (min ?b ?a)))
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (+ ?b (min ?d ?c)) (+ ?b (+ ?b ?a)))
// (< (+ ?b (min ?d ?c)) (+ ?b (+ ?b ?a))) ==> (< (min ?d ?c) (+ ?b ?a))
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (+ ?c (min ?d ?c)) (+ ?c (+ ?b ?a)))
// (< (+ ?c (min ?d ?c)) (+ ?c (+ ?b ?a))) ==> (< (min ?d ?c) (+ ?b ?a))
// (< (+ ?d ?c) (min ?b ?a)) ==> (< (+ ?d (+ ?c ?b)) (+ ?b (min ?b ?a)))
// (< (+ ?d (+ ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (+ ?d ?c) (min ?b ?a))
// (< (+ ?d ?c) (min ?b ?a)) ==> (< (+ ?d (+ ?c ?c)) (+ ?c (min ?b ?a)))
// (< (+ ?d (+ ?c ?c)) (+ ?c (min ?b ?a))) ==> (< (+ ?d ?c) (min ?b ?a))
// (< ?d (+ ?c (min ?b ?a))) ==> (< (min ?d (+ ?c ?b)) (+ ?c (min ?b ?a)))
// (< (min ?d (+ ?c ?b)) (+ ?c (min ?b ?a))) ==> (< ?d (+ ?c (min ?b ?a)))
// (< (+ ?d ?c) (min ?b ?a)) ==> (< (min ?b (+ ?d ?c)) (min ?b ?a))
// (< (min ?b (+ ?d ?c)) (min ?b ?a)) ==> (< (+ ?d ?c) (min ?b ?a))
// (< (min ?a (+ ?b ?b)) (+ ?a (+ ?a ?a))) ==> (< (+ ?b (min ?b ?a)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (min ?b ?a)) (+ ?a (+ ?a ?a))) ==> (< (min ?a (+ ?b ?b)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (+ ?b ?b)) (+ ?a ?a)) ==> (< (+ ?b (+ ?b ?b)) (+ ?a (min ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?b ?b)) (+ ?a (min ?b ?a))) ==> (< (+ ?b (+ ?b ?b)) (+ ?a ?a)) if (< ?a 0)
// (< (min ?b (+ ?a ?a)) (min ?b ?a)) ==> (< (+ ?b (+ ?a ?a)) (min ?a (+ ?b ?b))) if (< ?b 0)
// (< (+ ?b (+ ?a ?a)) (min ?a (+ ?b ?b))) ==> (< (min ?b (+ ?a ?a)) (min ?b ?a)) if (< ?b 0)
// (< (+ ?b ?b) ?a) ==> (< (+ ?b (+ ?b ?b)) (min ?a (+ ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?b ?b)) (min ?a (+ ?b ?a))) ==> (< (+ ?b ?b) ?a) if (< ?a 0)
// (< ?b (+ ?a ?a)) ==> (< (min ?b (+ ?b ?a)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (min ?b (+ ?b ?a)) (+ ?a (+ ?a ?a))) ==> (< ?b (+ ?a ?a)) if (< ?b 0)
// (+ ?b ?a) ==> (min ?b (+ ?b ?a)) if (< ?a 0)
// (min ?b (+ ?b ?a)) ==> (+ ?b ?a) if (< ?a 0)
// (min ?b (+ ?b ?a)) ==> ?b if (< 0 ?a)
// (< (min ?b (min ?a ?c)) (+ ?b (min ?a ?c))) ==> (< (min ?a (+ ?b ?b)) (+ ?b (min ?b ?a))) if (< ?a 0)
// (< (min ?b (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< (min ?c (min ?b ?a)) (+ ?a (min ?c ?b))) if (< ?c 0)
// (< (min ?c (min ?b ?a)) (+ ?a (min ?c ?b))) ==> (< (min ?b (+ ?c ?b)) (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?c (min ?b ?a)) (min ?b (+ ?a ?a))) ==> (< (+ ?c (min ?c ?b)) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?c (min ?c ?b)) (min ?b (+ ?a ?a))) ==> (< (+ ?c (min ?b ?a)) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?b (+ ?b ?b)) (+ ?c (min ?b ?a))) ==> (< (min ?b (+ ?b ?b)) (+ ?c (min ?a ?c))) if (< ?a 0)
// (< (min ?b (+ ?b ?b)) (+ ?c (min ?a ?c))) ==> (< (min ?b (+ ?b ?b)) (+ ?c (min ?b ?a))) if (< ?a 0)
// (< (+ ?c (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (+ ?c (min ?b ?a)) (min ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?c (min ?b ?a)) (min ?a (+ ?a ?a))) ==> (< (+ ?c (min ?c ?b)) (min ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?a ?a)) (min ?c (+ ?b ?b))) if (< ?b 0)
// (< (min ?b (+ ?a ?a)) (min ?c (+ ?b ?b))) ==> (< (+ ?a (min ?b ?a)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?c ?a)) (+ ?b (min ?b ?a))) ==> (< (+ ?a (min ?b ?c)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (+ ?a (min ?b ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?b (+ ?c ?a)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?c))) ==> (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?a))) ==> (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?c))) if (< ?b 0)
// (< (min ?c (+ ?c ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?b (+ ?c ?c)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?c ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?c (+ ?c ?c)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?a))) ==> (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?c))) if (< ?c 0)
// (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?c))) ==> (< (min ?b (+ ?c ?c)) (+ ?a (min ?b ?a))) if (< ?c 0)
// (< (min ?a (min ?b ?c)) (+ ?a (+ ?b ?b))) ==> (< (min ?a (+ ?a ?a)) (+ ?b (+ ?a ?a))) if (< 0 ?c)
// (< (min ?c (+ ?c ?a)) (min ?b (+ ?a ?a))) ==> (< (min ?c (+ ?c ?c)) (min ?b (+ ?a ?a))) if (< 0 ?b)
// (< (min ?c (+ ?c ?c)) (min ?b (+ ?a ?a))) ==> (< (min ?c (+ ?c ?a)) (min ?b (+ ?a ?a))) if (< 0 ?b)
// (< (min ?c (+ ?c ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?c (+ ?c ?b)) (+ ?b (min ?b ?a))) if (< 0 ?a)
// (< (min ?c (+ ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (min ?c (+ ?c ?c)) (+ ?b (min ?b ?a))) if (< 0 ?a)
// (< (+ ?b (min ?c ?b)) (+ ?a ?a)) ==> (< (+ ?b (min ?c ?b)) (min ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (+ ?b (min ?c ?b)) (+ ?a ?a)) if (< ?b 0)
// (< (+ ?b ?a) (+ ?c (min ?b ?a))) ==> (< (min ?c (+ ?b ?a)) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) (+ ?c (min ?b ?a))) ==> (< (+ ?b ?a) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (+ ?b ?b) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?b ?b)) (min ?c (+ ?a ?a))) if (< ?a 0)
// (< (min ?b (+ ?b ?b)) (min ?c (+ ?a ?a))) ==> (< (+ ?b ?b) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (min ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (min ?c (+ ?b ?b)) (min ?a (+ ?a ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?c (+ ?b ?b)) (+ ?a ?a)) if (< ?b 0)
// (< (+ ?c (min ?c ?b)) (+ ?a ?a)) ==> (< (+ ?c (min ?c ?b)) (min ?a (+ ?a ?a))) if (< ?c 0)
// (< (+ ?c (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (+ ?c (min ?c ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (min ?b (min ?a ?c)) (+ ?a (min ?b ?c))) ==> (< (min ?b ?a) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?b ?a) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?b ?a)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?b ?a)) (min ?c (+ ?b ?a))) ==> (< (min ?b ?a) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b ?b) (+ ?c (min ?b ?a))) ==> (< (min ?c (+ ?b ?b)) (+ ?c (min ?c ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?b)) (+ ?c (min ?c ?a))) ==> (< (+ ?b ?b) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (+ ?c (min ?b ?a)) (+ ?b ?a)) ==> (< (+ ?c (min ?b ?a)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c (min ?b ?a)) (min ?c (+ ?b ?a))) ==> (< (+ ?c (min ?b ?a)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b ?b) (min ?c (+ ?b ?a))) ==> (< (min ?a (+ ?b ?b)) (min ?c (+ ?a ?a))) if (< ?b 0)
// (< (min ?a (+ ?b ?b)) (min ?c (+ ?a ?a))) ==> (< (+ ?b ?b) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) ==> (< (+ ?b (+ ?a ?c)) (+ ?a (min ?b ?c))) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (+ ?a (min ?b ?c))) ==> (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?c (+ ?b ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?b ?c) (min ?b (+ ?c ?c))) if (< ?b 0)
// (< (min ?c (+ ?b ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?b ?c) (min ?b (+ ?b ?c))) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) ==> (< (+ ?c (min ?b ?a)) (min ?b (min ?a ?c))) if (< ?b 0)
// (< (+ ?c (min ?b ?a)) (min ?b (min ?a ?c))) ==> (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b ?b) (+ ?c (min ?b ?a))) ==> (< (min ?b (+ ?b ?b)) (+ ?c (min ?c ?a))) if (< ?c 0)
// (< (min ?b (+ ?b ?b)) (+ ?c (min ?c ?a))) ==> (< (+ ?b ?b) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (+ ?c (+ ?b ?b)) (+ ?a (min ?b ?a))) if (< ?c 0)
// (< (+ ?c (+ ?b ?b)) (+ ?a (min ?b ?a))) ==> (< (+ ?c (+ ?b ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (min ?a (min ?b ?c)) (+ ?a (min ?b ?c))) ==> (< (min ?a ?b) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?c ?b) (+ ?b (+ ?b ?a))) ==> (< (min ?c (min ?b ?a)) (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?c (min ?b ?a)) (+ ?b (+ ?b ?a))) ==> (< (min ?c ?b) (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?c ?b) (+ ?a (+ ?a ?a))) ==> (< (min ?c (min ?b ?a)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (min ?c (min ?b ?a)) (+ ?a (+ ?a ?a))) ==> (< (min ?c ?b) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (+ ?c ?c)) (min ?b ?a)) ==> (< (+ ?b (+ ?c ?c)) (min ?b (min ?c ?a))) if (< ?b 0)
// (< (+ ?b (+ ?c ?c)) (min ?b (min ?c ?a))) ==> (< (+ ?b (+ ?c ?c)) (min ?b ?a)) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) (+ ?b ?a)) ==> (< (+ ?b (min ?a ?c)) (+ ?a (+ ?b ?b))) if (< ?b 0)
// (< (+ ?b (min ?a ?c)) (+ ?a (+ ?b ?b))) ==> (< (min ?c (+ ?b ?a)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?c (+ ?c ?c)) (min ?b ?a)) ==> (< (+ ?c (+ ?c ?c)) (min ?c (min ?b ?a))) if (< ?b 0)
// (< (+ ?c (+ ?c ?c)) (min ?c (min ?b ?a))) ==> (< (+ ?c (+ ?c ?c)) (min ?b ?a)) if (< ?b 0)
// (< (min ?b ?c) (+ ?b (+ ?a ?a))) ==> (< (min ?b (min ?c ?a)) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?b (min ?c ?a)) (+ ?b (+ ?a ?a))) ==> (< (min ?b ?c) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?b (min ?c ?a)) (min ?b ?a)) ==> (< (min ?c (+ ?b ?c)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?b (min ?c ?a)) (min ?b ?a)) if (< ?b 0)
// (< (min ?c ?b) (+ ?c (+ ?b ?a))) ==> (< (min ?c (min ?b ?a)) (+ ?c (+ ?b ?a))) if (< 0 ?a)
...
// (< (+ ?b (+ ?a ?c)) (min ?b (min ?a ?c))) ==> (< (+ ?b (+ ?a ?c)) (min ?b ?a)) if (< 0 ?c)
// (< (+ ?b (+ ?c ?c)) (min ?c (min ?b ?a))) ==> (< (+ ?b (+ ?c ?c)) (min ?c ?b)) if (< 0 ?a)
// (< (+ ?b (+ ?a ?a)) (min ?b (min ?a ?c))) ==> (< (+ ?b (+ ?a ?a)) (min ?b ?a)) if (< 0 ?c)
...
// (< (min ?c (+ ?a ?b)) (+ ?b (min ?a ?c))) ==> (< ?a (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?a (+ ?c ?b)) ?a) ==> (< (+ ?a (+ ?c ?b)) (min ?a (+ ?a ?a))) if (< ?a 0)
// (< (+ ?a (+ ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?a (+ ?c ?b)) ?a) if (< ?a 0)
// (< ?c (+ ?b (+ ?b ?a))) ==> (< (min ?c (+ ?b ?a)) (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) (+ ?b (+ ?b ?a))) ==> (< ?c (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< ?c (min ?b (+ ?a ?a))) ==> (< (min ?c (min ?b ?a)) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?c (min ?b ?a)) (min ?b (+ ?a ?a))) ==> (< ?c (min ?b (+ ?a ?a))) if (< ?b 0)
// (< ?c (min ?b (+ ?b ?a))) ==> (< (min ?c (min ?b ?a)) (min ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?c (min ?b ?a)) (min ?b (+ ?b ?a))) ==> (< ?c (min ?b (+ ?b ?a))) if (< ?b 0)
// (< ?b (min ?c (+ ?b ?a))) ==> (< (min ?b (min ?a ?c)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (min ?a ?c)) (min ?c (+ ?b ?a))) ==> (< ?b (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b ?c) (min ?b ?a)) ==> (< (min ?c (+ ?b ?c)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?b ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?b ?c) (min ?b ?a)) if (< ?b 0)
// (< (min ?c (min ?b ?a)) ?a) ==> (< (+ ?c (min ?c ?b)) (min ?c (+ ?c ?a))) if (< ?b 0)
// (< (+ ?c (min ?c ?b)) (min ?c (+ ?c ?a))) ==> (< (min ?c (min ?b ?a)) ?a) if (< ?b 0)
// (< (min ?b (min ?a ?c)) (+ ?b (min ?a ?c))) ==> (< (min ?b ?a) (+ ?b ?a)) if (< ?a 0)
// (< (min ?c (+ ?a ?c)) (+ ?c (min ?a ?b))) ==> (< ?a (min ?a (+ ?a ?a))) if (< ?a 0)
// (< ?c (min ?c (+ ?b ?a))) ==> (< (min ?a (+ ?c ?b)) (+ ?b (min ?c ?a))) if (< ?b 0)
// (< (min ?a (+ ?c ?b)) (+ ?b (min ?c ?a))) ==> (< ?c (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?b ?a)) (min ?c (+ ?b ?a))) ==> (< ?b (min ?a (+ ?b ?b))) if (< ?a 0)
// (< (min ?a (min ?c ?b)) ?a) ==> (< (+ ?a (min ?c ?b)) (min ?c (+ ?a ?a))) if (< ?a 0)
// (< (+ ?a (min ?c ?b)) (min ?c (+ ?a ?a))) ==> (< (min ?a (min ?c ?b)) ?a) if (< ?a 0)
// (< (+ ?b (min ?a ?c)) (min ?c (+ ?a ?b))) ==> (< ?a (min ?a (+ ?a ?a))) if (< 0 ?b)
// (< (min ?b (+ ?a ?c)) (min ?a (+ ?a ?a))) ==> (< ?b (min ?a (+ ?a ?a))) if (< 0 ?c)
// (< (min ?a (+ ?b ?c)) (min ?b (+ ?a ?a))) ==> (< ?a (min ?b (+ ?a ?a))) if (< 0 ?c)
// (< (min ?c (+ ?b ?b)) ?a) ==> (< (min ?c (+ ?b ?b)) (min ?a (+ ?b ?a))) if (< 0 ?a)
// (< (min ?c (+ ?b ?b)) (min ?a (+ ?b ?a))) ==> (< (min ?c (+ ?b ?b)) ?a) if (< 0 ?a)
// (< ?c (min ?b (+ ?a ?a))) ==> (< (min ?c (+ ?a ?b)) (min ?b (+ ?a ?a))) if (< 0 ?b)
// (< (min ?c (+ ?a ?b)) (min ?b (+ ?a ?a))) ==> (< ?c (min ?b (+ ?a ?a))) if (< 0 ?b)
// (< (min ?b (min ?a ?c)) (+ ?b (min ?a ?c))) ==> (< (min ?b ?a) (+ ?b ?a)) if (< 0 ?c)
// (< (+ ?b (min ?b ?c)) ?a) ==> (< (+ ?b (min ?b ?c)) (min ?a (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?b (min ?b ?c)) (min ?a (+ ?b ?a))) ==> (< (+ ?b (min ?b ?c)) ?a) if (< 0 ?a)
// (< (min ?b (+ ?a ?c)) (min ?a (+ ?b ?a))) ==> (< ?b (min ?a (+ ?b ?a))) if (< 0 ?c)
// (< ?a (+ ?a (min ?b ?c))) ==> (< (min ?a ?b) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< ?c (min ?c (+ ?b ?a))) ==> (< (min ?c ?b) (min ?b (+ ?c ?c))) if (< ?b 0)
// (< (+ ?c ?b) ?a) ==> (< (+ ?c (+ ?b ?b)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c (+ ?b ?b)) (min ?a (+ ?b ?a))) ==> (< (+ ?c ?b) ?a) if (< ?b 0)
// (< ?c (min ?b ?a)) ==> (< (min ?a (+ ?c ?b)) (+ ?b (min ?b ?a))) if (< ?b 0)
// (< (min ?a (+ ?c ?b)) (+ ?b (min ?b ?a))) ==> (< ?c (min ?b ?a)) if (< ?b 0)
// (< ?c (min ?b ?a)) ==> (< (min ?c (+ ?c ?c)) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?c ?c)) (+ ?c (min ?b ?a))) ==> (< ?c (min ?b ?a)) if (< ?b 0)
// (< (min ?c ?b) ?a) ==> (< (+ ?c (min ?c ?b)) (min ?c (+ ?c ?a))) if (< ?b 0)
// (< (+ ?c (min ?c ?b)) (min ?c (+ ?c ?a))) ==> (< (min ?c ?b) ?a) if (< ?b 0)
// (< (+ ?c ?c) (min ?b ?a)) ==> (< (min ?c (+ ?c ?c)) (min ?b ?a)) if (< ?b 0)
// (< (min ?c (+ ?c ?c)) (min ?b ?a)) ==> (< (+ ?c ?c) (min ?b ?a)) if (< ?b 0)
// (< ?b (min ?c (+ ?b ?a))) ==> (< (min ?b ?a) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b ?a) (min ?c (+ ?b ?a))) ==> (< ?b (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (min ?a ?c)) ?a) ==> (< (+ ?b (min ?a ?c)) (min ?b ?a)) if (< ?a 0)
// (< (+ ?b (min ?a ?c)) (min ?b ?a)) ==> (< (+ ?b (min ?a ?c)) ?a) if (< ?a 0)
// (< (+ ?a (min ?c ?b)) (min ?a (min ?c ?b))) ==> (< (+ ?a ?a) ?a) if (< ?c 0)
// (< (+ ?c ?c) (min ?b ?a)) ==> (< (+ ?c ?c) (min ?c (min ?b ?a))) if (< ?b 0)
// (< (+ ?c ?c) (min ?c (min ?b ?a))) ==> (< (+ ?c ?c) (min ?b ?a)) if (< ?b 0)
// (< (min ?a (min ?c ?b)) (+ ?a (min ?c ?b))) ==> (< ?a (+ ?a ?a)) if (< ?c 0)
// (< (min ?c ?b) ?a) ==> (< (+ ?a (min ?c ?b)) (min ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?a (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?c ?b) ?a) if (< ?b 0)
// (< (min ?c ?b) ?a) ==> (< (+ ?b (min ?c ?b)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (min ?c ?b)) (min ?c (+ ?b ?a))) ==> (< (min ?c ?b) ?a) if (< ?b 0)
// (< ?c (+ ?b ?a)) ==> (< (min ?a (+ ?c ?b)) (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?a (+ ?c ?b)) (+ ?b (+ ?b ?a))) ==> (< ?c (+ ?b ?a)) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) ?b) ==> (< (min ?c (+ ?b ?a)) (min ?b ?a)) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) (min ?b ?a)) ==> (< (min ?c (+ ?b ?a)) ?b) if (< ?b 0)
// (< ?b (+ ?c (min ?b ?a))) ==> (< (min ?b ?c) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?b ?c) (+ ?c (min ?b ?a))) ==> (< ?b (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?c ?b) (+ ?a ?a)) ==> (< (min ?c (min ?b ?a)) (+ ?a ?a)) if (< ?b 0)
// (< (min ?c (min ?b ?a)) (+ ?a ?a)) ==> (< (min ?c ?b) (+ ?a ?a)) if (< ?b 0)
// (< ?c (+ ?b ?a)) ==> (< (min ?c (+ ?c ?b)) (+ ?b (+ ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?c ?b)) (+ ?b (+ ?b ?a))) ==> (< ?c (+ ?b ?a)) if (< ?b 0)
// (< ?c (+ ?b ?a)) ==> (< (min ?c (+ ?b ?a)) (min ?a (+ ?b ?a))) if (< ?b 0)
...
// (< (+ ?a (min ?b ?c)) ?c) ==> (< (+ ?a (min ?a ?b)) ?a) if (< ?a 0)
// (< ?c (min ?c (+ ?b ?a))) ==> (< ?c (min ?b (+ ?c ?c))) if (< ?b 0)
// (< (+ ?c (min ?a ?b)) ?a) ==> (< (min ?c (+ ?a ?a)) ?a) if (< ?c 0)
// (< ?a (+ ?c (min ?a ?b))) ==> (< ?a (min ?a (+ ?a ?a))) if (< ?c 0)
// (< (+ ?b (min ?a ?c)) ?c) ==> (< (min ?b (+ ?a ?a)) ?a) if (< ?b 0)
// (< ?a (+ ?a (min ?b ?c))) ==> (< ?a (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?a (min ?b ?c)) ?c) ==> (< (min ?b (+ ?a ?a)) ?a) if (< ?a 0)
// (< (min ?c (+ ?b ?a)) ?a) ==> (< (min ?b (+ ?a ?a)) ?a) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) ?a) ==> (< (min ?b (+ ?c ?c)) ?c) if (< ?b 0)
// (< (min ?c (+ ?a ?b)) ?a) ==> (< (min ?b (+ ?a ?a)) ?a) if (< ?b 0)
// (< ?c (min ?c (+ ?b ?a))) ==> (< ?c (+ ?c (min ?c ?b))) if (< ?c 0)
// (< (+ ?a (min ?b ?c)) ?a) ==> (< (min ?b (+ ?a ?a)) ?a) if (< ?b 0)
// (< (min ?c (+ ?b ?a)) ?a) ==> (< (+ ?b (min ?a ?c)) ?c) if (< ?b 0)
// (< (+ ?b (min ?a ?c)) ?c) ==> (< (min ?c (+ ?b ?a)) ?a) if (< ?b 0)
// (< ?b (+ ?b (min ?a ?c))) ==> (< ?b (min ?c (+ ?b ?a))) if (< ?a 0)
// (< ?b (min ?c (+ ?b ?a))) ==> (< ?b (+ ?b (min ?a ?c))) if (< ?a 0)
// (< ?b (min ?a (+ ?b ?c))) ==> (< ?b (+ ?c (min ?b ?a))) if (< ?c 0)
// (< ?b (+ ?c (min ?b ?a))) ==> (< ?b (min ?a (+ ?b ?c))) if (< ?c 0)
// (< ?a (+ ?a (min ?c ?b))) ==> (< ?a (min ?a (+ ?a ?a))) if (< ?c 0)
// (< ?b (+ ?b (min ?a ?c))) ==> (< ?b (min ?b (+ ?b ?a))) if (< ?a 0)
// (< (min ?a (+ ?b ?a)) (min ?c (+ ?b ?a))) ==> 0 if (< ?b 0)
// (< ?c (+ ?b ?a)) ==> (< ?c (min ?a (+ ?b ?a))) if (< ?b 0)
// (< ?c (min ?a (+ ?b ?a))) ==> (< ?c (+ ?b ?a)) if (< ?b 0)
// (< (+ ?c ?b) ?a) ==> (< (+ ?c ?b) (min ?b ?a)) if (< ?c 0)
// (< (+ ?c ?b) (min ?b ?a)) ==> (< (+ ?c ?b) ?a) if (< ?c 0)
// (< (+ ?c ?b) ?a) ==> (< (min ?b (+ ?c ?b)) ?a) if (< ?c 0)
// (< (min ?b (+ ?c ?b)) ?a) ==> (< (+ ?c ?b) ?a) if (< ?c 0)
// (< (+ ?a (min ?b ?c)) ?a) ==> (< (+ ?a ?b) ?a) if (< 0 ?c)
// (< ?c (+ ?b ?a)) ==> (< ?c (+ ?a (min ?c ?b))) if (< 0 ?a)
// (< ?c (+ ?a (min ?c ?b))) ==> (< ?c (+ ?b ?a)) if (< 0 ?a)
// (< (min ?b ?c) (+ ?b (+ ?a ?a))) ==> 1 if (< 0 ?a)
// (< ?c (min ?c (+ ?b ?a))) ==> 0 if (< ?c 0)
// (< (+ ?a (min ?c ?b)) ?a) ==> 1 if (< ?c 0)
// (< ?c (min ?c (+ ?b ?a))) ==> 0 if (< ?b 0)
// (< (+ ?c (min ?a ?b)) ?a) ==> 1 if (< ?c 0)
// (< (min ?c (+ ?a ?b)) ?a) ==> 1 if (< ?b 0)
// (< (min ?b (min ?d ?c)) (+ ?b (+ ?a ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?d (+ ?a ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (+ ?d (+ ?a ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?b (+ ?a ?a))) if (< 0 ?a)
// (< (min ?b (+ ?c ?d)) (+ ?d (+ ?c ?a))) ==> (< (+ ?c (min ?d ?b)) (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?c (min ?d ?b)) (+ ?c (+ ?b ?a))) ==> (< (min ?b (+ ?c ?d)) (+ ?d (+ ?c ?a))) if (< 0 ?a)
// (< (min ?a (+ ?b ?d)) (+ ?d (+ ?b ?c))) ==> (< (min ?b (min ?d ?a)) (+ ?c (min ?b ?a))) if (< 0 ?c)
// (< (min ?b (min ?d ?a)) (+ ?c (min ?b ?a))) ==> (< (min ?a (+ ?b ?d)) (+ ?d (+ ?b ?c))) if (< 0 ?c)
// (< (min ?d (min ?b ?a)) (+ ?c (min ?b ?a))) ==> (< (min ?d (min ?b ?a)) (+ ?c (min ?d ?b))) if (< 0 ?c)
// (< (min ?d (min ?b ?a)) (+ ?c (min ?d ?b))) ==> (< (min ?d (min ?b ?a)) (+ ?c (min ?b ?a))) if (< 0 ?c)
// (< (min ?b (min ?c ?d)) (+ ?c (min ?b ?a))) ==> (< (min ?b (min ?c ?d)) (+ ?b (min ?c ?a))) if (< 0 ?a)
// (< (min ?b (min ?c ?d)) (+ ?b (min ?c ?a))) ==> (< (min ?b (min ?c ?d)) (+ ?c (min ?b ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (min ?b (+ ?b ?a))) ==> (< (min ?b (min ?d ?c)) (min ?b (+ ?c ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (min ?b (+ ?c ?a))) ==> (< (min ?b (min ?d ?c)) (min ?b (+ ?b ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?c (min ?d ?a))) if (< 0 ?c)
// (< (min ?b (min ?d ?c)) (+ ?c (min ?d ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?c (min ?b ?a))) if (< 0 ?c)
// (< (min ?b (min ?d ?a)) (min ?c (+ ?b ?a))) ==> (< (min ?b (min ?d ?a)) (min ?c (+ ?a ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?a)) (min ?c (+ ?a ?a))) ==> (< (min ?b (min ?d ?a)) (min ?c (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?b (min ?d ?c)) (+ ?c (+ ?b ?a))) ==> (< (min ?b (+ ?d ?c)) (+ ?c (+ ?d ?a))) if (< 0 ?a)
// (< (min ?b (+ ?d ?c)) (+ ?c (+ ?d ?a))) ==> (< (+ ?b (min ?d ?c)) (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?a))) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?a))) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?a ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?a)) (+ ?c (min ?b ?a))) ==> (< (+ ?b (min ?d ?a)) (+ ?d (+ ?b ?c))) if (< 0 ?c)
// (< (+ ?b (min ?d ?a)) (+ ?d (+ ?b ?c))) ==> (< (min ?b (min ?d ?a)) (+ ?c (min ?b ?a))) if (< 0 ?c)
// (< (+ ?d ?c) (+ ?b (+ ?a ?a))) ==> (< (min ?b (+ ?d ?c)) (+ ?b (+ ?a ?a))) if (< ?a 0)
// (< (min ?b (+ ?d ?c)) (+ ?b (+ ?a ?a))) ==> (< (+ ?d ?c) (+ ?b (+ ?a ?a))) if (< ?a 0)
// (< (min ?d ?c) (+ ?b (+ ?a ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?b (+ ?a ?a))) if (< ?a 0)
// (< (min ?d (min ?c ?b)) (+ ?b (+ ?a ?a))) ==> (< (min ?d ?c) (+ ?b (+ ?a ?a))) if (< ?a 0)
// (< (+ ?d ?d) (min ?c (min ?b ?a))) ==> (< (min ?d (+ ?d ?d)) (min ?c (min ?b ?a))) if (< ?a 0)
// (< (min ?d (+ ?d ?d)) (min ?c (min ?b ?a))) ==> (< (+ ?d ?d) (min ?c (min ?b ?a))) if (< ?a 0)
// (< (+ ?d ?c) (min ?b (+ ?a ?a))) ==> (< (min ?a (+ ?d ?c)) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?a (+ ?d ?c)) (min ?b (+ ?a ?a))) ==> (< (+ ?d ?c) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?d ?b) (+ ?c (min ?b ?a))) ==> (< (min ?d (min ?b ?c)) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?d (min ?b ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?d ?b) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?d (+ ?c ?c)) (min ?b ?a)) ==> (< (min ?d (+ ?c ?c)) (min ?c (min ?b ?a))) if (< ?a 0)
// (< (min ?d (+ ?c ?c)) (min ?c (min ?b ?a))) ==> (< (min ?d (+ ?c ?c)) (min ?b ?a)) if (< ?a 0)
// (< (+ ?c ?d) (+ ?c (+ ?b ?a))) ==> (< (+ ?c (min ?d ?b)) (+ ?c (+ ?b ?a))) if (< ?a 0)
// (< (+ ?c (min ?d ?b)) (+ ?c (+ ?b ?a))) ==> (< (+ ?c ?d) (+ ?c (+ ?b ?a))) if (< ?a 0)
// (< (+ ?d (min ?c ?b)) (+ ?b ?a)) ==> (< (+ ?d (min ?c ?b)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?d (min ?c ?b)) (min ?a (+ ?b ?a))) ==> (< (+ ?d (min ?c ?b)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?d ?b) (+ ?c (min ?b ?a))) ==> (< (min ?c (+ ?d ?b)) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?c (+ ?d ?b)) (+ ?c (min ?b ?a))) ==> (< (+ ?d ?b) (+ ?c (min ?b ?a))) if (< ?b 0)
// (< (min ?d ?c) (+ ?b (min ?b ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?b (min ?b ?a))) if (< ?c 0)
// (< (min ?d (min ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (min ?d ?c) (+ ?b (min ?b ?a))) if (< ?c 0)
// (< (+ ?d (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?d (min ?d ?c)) (min ?d (min ?b ?a))) if (< ?a 0)
// (< (+ ?d (min ?d ?c)) (min ?d (min ?b ?a))) ==> (< (+ ?d (min ?d ?c)) (min ?b ?a)) if (< ?a 0)
// (< (min ?b (+ ?d ?c)) (+ ?b ?a)) ==> (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (min ?b (+ ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?d ?c) (+ ?b (min ?b ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?b (min ?b ?a))) if (< ?d 0)
// (< (min ?d (min ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (min ?d ?c) (+ ?b (min ?b ?a))) if (< ?d 0)
// (< (+ ?c (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?c (min ?d ?c)) (min ?c (min ?b ?a))) if (< ?a 0)
// (< (+ ?c (min ?d ?c)) (min ?c (min ?b ?a))) ==> (< (+ ?c (min ?d ?c)) (min ?b ?a)) if (< ?a 0)
// (< (+ ?b ?d) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?b ?d)) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (min ?b (+ ?b ?d)) (min ?c (+ ?b ?a))) ==> (< (+ ?b ?d) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (+ ?b (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?b (min ?d ?c)) (min ?b (min ?d ?a))) if (< ?b 0)
// (< (+ ?b (min ?d ?c)) (min ?b (min ?d ?a))) ==> (< (+ ?b (min ?d ?c)) (min ?b ?a)) if (< ?b 0)
// (< (min ?d ?c) (min ?b (+ ?a ?a))) ==> (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) if (< ?c 0)
// (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) ==> (< (min ?d ?c) (min ?b (+ ?a ?a))) if (< ?c 0)
// (< (min ?d (+ ?c ?b)) (+ ?a ?a)) ==> (< (min ?d (+ ?c ?b)) (min ?b (+ ?a ?a))) if (< ?c 0)
// (< (min ?d (+ ?c ?b)) (min ?b (+ ?a ?a))) ==> (< (min ?d (+ ?c ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (min ?b (min ?d ?c)) (+ ?b ?a)) ==> (< (min ?b (min ?d ?c)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (min ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?d ?c) (min ?b (+ ?a ?a))) ==> (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) ==> (< (min ?d ?c) (min ?b (+ ?a ?a))) if (< ?b 0)
// (< (min ?a (min ?d ?c)) (+ ?a ?b)) ==> (< (+ ?a (min ?d ?c)) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?a (min ?d ?c)) (+ ?b (+ ?a ?a))) ==> (< (min ?a (min ?d ?c)) (+ ?a ?b)) if (< ?b 0)
// (< (min ?c ?d) (min ?c (+ ?b ?a))) ==> (< (min ?c (min ?d ?b)) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (min ?c (min ?d ?b)) (min ?c (+ ?b ?a))) ==> (< (min ?c ?d) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (+ ?d ?d) (min ?c (+ ?b ?a))) ==> (< (min ?d (+ ?d ?d)) (min ?c (+ ?b ?a))) if (< ?c 0)
// (< (min ?d (+ ?d ?d)) (min ?c (+ ?b ?a))) ==> (< (+ ?d ?d) (min ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?d (min ?c ?b)) (+ ?a ?a)) ==> (< (+ ?d (min ?c ?b)) (min ?d (+ ?a ?a))) if (< ?c 0)
// (< (+ ?d (min ?c ?b)) (min ?d (+ ?a ?a))) ==> (< (+ ?d (min ?c ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (+ ?d ?d) (min ?c (min ?b ?a))) ==> (< (min ?d (+ ?d ?d)) (min ?c (min ?b ?a))) if (< ?c 0)
// (< (min ?d (+ ?d ?d)) (min ?c (min ?b ?a))) ==> (< (+ ?d ?d) (min ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?c (min ?d ?b)) (min ?c ?a)) ==> (< (+ ?c (min ?d ?b)) (min ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?c (min ?d ?b)) (min ?c (min ?b ?a))) ==> (< (+ ?c (min ?d ?b)) (min ?c ?a)) if (< ?c 0)
// (< (min ?d (min ?c ?b)) (+ ?a ?a)) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?a ?a))) if (< ?c 0)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (min ?a (+ ?d ?c)) (+ ?a ?b)) ==> (< (+ ?a (+ ?d ?c)) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?a (+ ?d ?c)) (+ ?b (+ ?a ?a))) ==> (< (min ?a (+ ?d ?c)) (+ ?a ?b)) if (< ?b 0)
// (< (+ ?d ?b) (+ ?c (min ?b ?a))) ==> (< (min ?a (+ ?d ?b)) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (min ?a (+ ?d ?b)) (+ ?c (min ?b ?a))) ==> (< (+ ?d ?b) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?c ?d) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?c ?d)) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (min ?b (+ ?c ?d)) (min ?c (+ ?b ?a))) ==> (< (+ ?c ?d) (min ?c (+ ?b ?a))) if (< ?a 0)
// (< (+ ?c (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?c (min ?d ?c)) (min ?d (min ?b ?a))) if (< ?c 0)
// (< (+ ?c (min ?d ?c)) (min ?d (min ?b ?a))) ==> (< (+ ?c (min ?d ?c)) (min ?b ?a)) if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) (+ ?b ?a)) ==> (< (+ ?d (+ ?c ?b)) (+ ?b (min ?d ?a))) if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) (+ ?b (min ?d ?a))) ==> (< (+ ?d (+ ?c ?b)) (+ ?b ?a)) if (< ?c 0)
// (< (+ ?b (min ?d ?c)) (+ ?b ?a)) ==> (< (+ ?b (min ?d ?c)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (min ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (+ ?b (min ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?d ?c) (+ ?c (min ?b ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (min ?d (min ?c ?b)) (+ ?c (min ?b ?a))) ==> (< (min ?d ?c) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?b (min ?d ?c)) (+ ?b ?a)) ==> (< (+ ?b (min ?d ?c)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (min ?d ?c)) (min ?c (+ ?b ?a))) ==> (< (+ ?b (min ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?d (+ ?c ?b)) (+ ?a ?a)) ==> (< (min ?d (+ ?c ?b)) (min ?a (+ ?a ?a))) if (< ?d 0)
// (< (min ?d (+ ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?d (+ ?c ?b)) (+ ?a ?a)) if (< ?d 0)
// (< (+ ?d ?c) (min ?a (+ ?b ?a))) ==> (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) if (< ?a 0)
// (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (+ ?d ?c) (min ?a (+ ?b ?a))) if (< ?a 0)
// (< (+ ?c (min ?d ?c)) (+ ?b ?a)) ==> (< (+ ?c (min ?d ?c)) (min ?d (+ ?b ?a))) if (< ?c 0)
// (< (+ ?c (min ?d ?c)) (min ?d (+ ?b ?a))) ==> (< (+ ?c (min ?d ?c)) (+ ?b ?a)) if (< ?c 0)
// (< (min ?d (+ ?c ?c)) (+ ?b ?a)) ==> (< (min ?d (+ ?c ?c)) (min ?c (+ ?b ?a))) if (< ?d 0)
// (< (min ?d (+ ?c ?c)) (min ?c (+ ?b ?a))) ==> (< (min ?d (+ ?c ?c)) (+ ?b ?a)) if (< ?d 0)
// (< (+ ?b (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (+ ?b (+ ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?d ?b) (min ?c (+ ?b ?a))) ==> (< (min ?a (+ ?d ?b)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?a (+ ?d ?b)) (min ?c (+ ?b ?a))) ==> (< (+ ?d ?b) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?d (+ ?b ?c)) (+ ?b ?a)) ==> (< (min ?d (+ ?b ?c)) (min ?a (+ ?b ?a))) if (< ?b 0)
// (< (min ?d (+ ?b ?c)) (min ?a (+ ?b ?a))) ==> (< (min ?d (+ ?b ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (min ?d ?c) (min ?a (+ ?b ?a))) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?b ?a))) if (< ?a 0)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?b ?a))) ==> (< (min ?d ?c) (min ?a (+ ?b ?a))) if (< ?a 0)
// (< (min ?b ?d) (min ?c (+ ?b ?a))) ==> (< (min ?b (min ?d ?a)) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (min ?b (min ?d ?a)) (min ?c (+ ?b ?a))) ==> (< (min ?b ?d) (min ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?d (+ ?c ?b)) (+ ?b ?a)) ==> (< (+ ?d (+ ?c ?b)) (+ ?b (min ?c ?a))) if (< ?d 0)
// (< (+ ?d (+ ?c ?b)) (+ ?b (min ?c ?a))) ==> (< (+ ?d (+ ?c ?b)) (+ ?b ?a)) if (< ?d 0)
// (< (min ?d ?c) (min ?b (+ ?a ?a))) ==> (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) if (< ?d 0)
// (< (min ?d (min ?c ?a)) (min ?b (+ ?a ?a))) ==> (< (min ?d ?c) (min ?b (+ ?a ?a))) if (< ?d 0)
// (< (+ ?d (min ?c ?b)) (min ?b ?a)) ==> (< (+ ?c (+ ?b ?d)) (+ ?b (min ?b ?a))) if (< 0 ?d)
// (< (+ ?c (+ ?b ?d)) (+ ?b (min ?b ?a))) ==> (< (+ ?d (min ?c ?b)) (min ?b ?a)) if (< 0 ?d)
// (< (min ?c (+ ?d ?b)) (+ ?c (min ?b ?a))) ==> (< (min ?c (+ ?d ?b)) (+ ?b ?c)) if (< 0 ?a)
// (< (min ?b (+ ?d ?c)) (+ ?b (min ?b ?a))) ==> (< (min ?b (+ ?d ?c)) (+ ?b ?b)) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (+ ?b ?a)) ==> (< (min ?b (min ?d ?c)) (+ ?b (min ?c ?a))) if (< 0 ?c)
// (< (min ?b (min ?d ?c)) (+ ?b (min ?c ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?b ?a)) if (< 0 ?c)
// (< (+ ?b (+ ?a ?c)) (+ ?a (min ?b ?d))) ==> (< (min ?b (+ ?a ?c)) (min ?b ?a)) if (< 0 ?c)
// (< (+ ?b (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?b (+ ?d ?c)) (+ ?c (min ?b ?a))) if (< 0 ?c)
// (< (+ ?b (+ ?d ?c)) (+ ?c (min ?b ?a))) ==> (< (+ ?b (min ?d ?c)) (min ?b ?a)) if (< 0 ?c)
// (< (min ?b (min ?d ?c)) (+ ?b ?a)) ==> (< (min ?b (min ?d ?c)) (+ ?d (+ ?a ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (+ ?d (+ ?a ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?b ?a)) if (< 0 ?a)
...
// (< (min ?d (min ?c ?b)) (+ ?b ?a)) ==> (< (+ ?d (min ?c ?b)) (+ ?d (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?d (min ?c ?b)) (+ ?d (+ ?b ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?b ?a)) if (< 0 ?a)
// (< (min ?d (min ?b ?c)) (+ ?a ?a)) ==> (< (min ?d (min ?b ?c)) (+ ?a (min ?b ?a))) if (< 0 ?a)
// (< (min ?d (min ?b ?c)) (+ ?a (min ?b ?a))) ==> (< (min ?d (min ?b ?c)) (+ ?a ?a)) if (< 0 ?a)
...
// (< (min ?c (+ ?d ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?c (+ ?d ?c)) (+ ?c ?b)) if (< 0 ?a)
// (< (min ?d (+ ?c ?b)) (+ ?a ?a)) ==> (< (min ?d (+ ?c ?b)) (+ ?a (min ?d ?a))) if (< 0 ?d)
// (< (min ?d (+ ?c ?b)) (+ ?a (min ?d ?a))) ==> (< (min ?d (+ ?c ?b)) (+ ?a ?a)) if (< 0 ?d)
// (< (min ?b ?d) (min ?c (+ ?b ?a))) ==> (< (min ?b (min ?d ?c)) (min ?c (+ ?d ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (min ?c (+ ?d ?a))) ==> (< (min ?b ?d) (min ?c (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?c ?d) (min ?c (+ ?b ?a))) ==> (< (+ ?c (min ?d ?b)) (min ?c (+ ?b ?a))) if (< 0 ?b)
// (< (+ ?c (min ?d ?b)) (min ?c (+ ?b ?a))) ==> (< (+ ?c ?d) (min ?c (+ ?b ?a))) if (< 0 ?b)
// (< (min ?b (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?d (min ?c ?b)) (+ ?c (+ ?d ?a))) if (< 0 ?a)
// (< (+ ?d (min ?c ?b)) (+ ?c (+ ?d ?a))) ==> (< (min ?b (+ ?d ?c)) (+ ?b ?a)) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (+ ?c (min ?b ?a))) ==> (< (min ?b (min ?d ?c)) (+ ?b ?c)) if (< 0 ?a)
// (< (min ?b ?d) (min ?c (+ ?d ?a))) ==> (< (min ?b (min ?d ?c)) (min ?c (+ ?b ?a))) if (< 0 ?a)
// (< (min ?b (min ?d ?c)) (min ?c (+ ?b ?a))) ==> (< (min ?b ?d) (min ?c (+ ?d ?a))) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (+ ?b (min ?b ?a))) ==> (< (min ?d (min ?c ?b)) (+ ?b ?b)) if (< 0 ?a)
// (< ?d (+ ?c (min ?b ?a))) ==> (< (min ?d (min ?b ?a)) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (min ?d (min ?b ?a)) (+ ?c (min ?b ?a))) ==> (< ?d (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) ?a) ==> (< (+ ?d (+ ?c ?b)) (min ?a (+ ?d ?b))) if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) (min ?a (+ ?d ?b))) ==> (< (+ ?d (+ ?c ?b)) ?a) if (< ?c 0)
// (< ?d (+ ?c (+ ?b ?a))) ==> (< (min ?d (+ ?c ?b)) (+ ?c (+ ?b ?a))) if (< ?a 0)
// (< (min ?d (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< ?d (+ ?c (+ ?b ?a))) if (< ?a 0)
...
// (< (+ ?a (min ?b ?d)) (+ ?a ?c)) ==> (< (min ?b ?d) (min ?c (+ ?b ?a))) if (< 0 ?a)
// (< (min ?b (+ ?d ?c)) (min ?b ?a)) ==> (< (+ ?c (min ?b ?d)) (min ?b ?a)) if (< 0 ?c)
// (< (+ ?c (min ?b ?d)) (min ?b ?a)) ==> (< (min ?b (+ ?d ?c)) (min ?b ?a)) if (< 0 ?c)
// (< (min ?d ?c) (min ?b (+ ?b ?a))) ==> (< (min ?d ?c) (min ?b (+ ?d ?a))) if (< 0 ?a)
// (< (min ?d ?c) (min ?b (+ ?d ?a))) ==> (< (min ?d ?c) (min ?b (+ ?b ?a))) if (< 0 ?a)
// (< (min ?d ?c) (min ?b (+ ?b ?a))) ==> (< (min ?d ?c) (min ?b (+ ?c ?a))) if (< 0 ?a)
// (< (min ?d ?c) (min ?b (+ ?c ?a))) ==> (< (min ?d ?c) (min ?b (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?a (+ ?b ?d)) (min ?d (+ ?d ?c))) ==> (< (+ ?b (+ ?a ?a)) ?a) if (< 0 ?c)
// (< (min ?b (min ?d ?c)) (min ?b (+ ?b ?a))) ==> (< (min ?b (min ?d ?c)) ?b) if (< 0 ?a)
// (< (min ?b (+ ?d ?b)) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?d ?b)) ?c) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) ?a) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?a))) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?a))) ==> (< (min ?d (min ?c ?b)) ?a) if (< 0 ?a)
// (< (min ?d (+ ?b ?c)) (min ?b (+ ?b ?a))) ==> (< (min ?d (+ ?b ?c)) ?b) if (< 0 ?a)
// (< (min ?b (+ ?c ?d)) (min ?c (+ ?b ?a))) ==> (< (min ?b (+ ?c ?d)) ?c) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) ?a) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?b ?a))) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?b ?a))) ==> (< (min ?d (min ?c ?b)) ?a) if (< 0 ?a)
// (< (min ?d (+ ?c ?b)) ?a) ==> (< (min ?d (+ ?c ?b)) (min ?a (+ ?a ?a))) if (< 0 ?a)
// (< (min ?d (+ ?c ?b)) (min ?a (+ ?a ?a))) ==> (< (min ?d (+ ?c ?b)) ?a) if (< 0 ?a)
// (< (min ?a (+ ?d ?c)) ?b) ==> (< (min ?a (+ ?d ?c)) (min ?b (+ ?a ?a))) if (< 0 ?a)
// (< (min ?a (+ ?d ?c)) (min ?b (+ ?a ?a))) ==> (< (min ?a (+ ?d ?c)) ?b) if (< 0 ?a)
// (< (min ?c (+ ?d ?c)) (min ?b (+ ?b ?a))) ==> (< (min ?c (+ ?d ?c)) ?b) if (< 0 ?a)
// (< (min ?b (+ ?d ?c)) ?a) ==> (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) if (< 0 ?a)
// (< (min ?b (+ ?d ?c)) (min ?a (+ ?b ?a))) ==> (< (min ?b (+ ?d ?c)) ?a) if (< 0 ?a)
// (< (min ?d (min ?c ?b)) (min ?c (+ ?b ?a))) ==> (< (min ?d (min ?c ?b)) ?c) if (< 0 ?a)
// (< ?d (min ?c (min ?b ?a))) ==> (< (min ?d (+ ?c ?b)) (min ?c (min ?b ?a))) if (< 0 ?b)
// (< (min ?d (+ ?c ?b)) (min ?c (min ?b ?a))) ==> (< ?d (min ?c (min ?b ?a))) if (< 0 ?b)
// (< ?d (min ?c (+ ?b ?a))) ==> (< (min ?d (+ ?c ?b)) (min ?c (+ ?b ?a))) if (< 0 ?b)
// (< (min ?d (+ ?c ?b)) (min ?c (+ ?b ?a))) ==> (< ?d (min ?c (+ ?b ?a))) if (< 0 ?b)
// (< (min ?d (min ?c ?b)) ?a) ==> (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?b))) if (< 0 ?b)
// (< (min ?d (min ?c ?b)) (min ?a (+ ?c ?b))) ==> (< (min ?d (min ?c ?b)) ?a) if (< 0 ?b)
// (< (+ ?c (+ ?b ?a)) (min ?d (+ ?c ?b))) ==> (< ?c (min ?c (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?d ?c) (+ ?b ?a)) ==> (< (min ?d (+ ?d ?c)) (+ ?b ?a)) if (< ?c 0)
// (< (min ?d (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?d ?c) (+ ?b ?a)) if (< ?c 0)
// (< (+ ?d ?c) (min ?b ?a)) ==> (< (min ?d (+ ?d ?c)) (min ?b ?a)) if (< ?c 0)
// (< (min ?d (+ ?d ?c)) (min ?b ?a)) ==> (< (+ ?d ?c) (min ?b ?a)) if (< ?c 0)
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (min ?d ?c) (min ?b (+ ?b ?a))) if (< ?a 0)
// (< (min ?d ?c) (min ?b (+ ?b ?a))) ==> (< (min ?d ?c) (+ ?b ?a)) if (< ?a 0)
// (< ?d (+ ?c (min ?b ?a))) ==> (< (min ?d ?c) (+ ?c (min ?b ?a))) if (< ?a 0)
// (< (min ?d ?c) (+ ?c (min ?b ?a))) ==> (< ?d (+ ?c (min ?b ?a))) if (< ?a 0)
// (< (+ ?d ?c) (+ ?b ?a)) ==> (< (min ?b (+ ?d ?c)) (+ ?b ?a)) if (< ?a 0)
// (< (min ?b (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?d ?c) (+ ?b ?a)) if (< ?a 0)
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (min ?d (min ?c ?b)) (+ ?b ?a)) if (< ?a 0)
// (< (min ?d (min ?c ?b)) (+ ?b ?a)) ==> (< (min ?d ?c) (+ ?b ?a)) if (< ?a 0)
// (< (+ ?d ?c) (+ ?b ?a)) ==> (< (+ ?d ?c) (min ?b (+ ?b ?a))) if (< ?a 0)
// (< (+ ?d ?c) (min ?b (+ ?b ?a))) ==> (< (+ ?d ?c) (+ ?b ?a)) if (< ?a 0)
// (< (+ ?b (min ?d ?c)) ?a) ==> (< (+ ?b (min ?d ?c)) (min ?b ?a)) if (< ?c 0)
// (< (+ ?b (min ?d ?c)) (min ?b ?a)) ==> (< (+ ?b (min ?d ?c)) ?a) if (< ?c 0)
// (< (+ ?d ?c) (+ ?b ?a)) ==> (< (min ?c (+ ?d ?c)) (+ ?b ?a)) if (< ?d 0)
// (< (min ?c (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?d ?c) (+ ?b ?a)) if (< ?d 0)
// (< ?d (+ ?c (min ?b ?a))) ==> (< (min ?d ?b) (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (min ?d ?b) (+ ?c (min ?b ?a))) ==> (< ?d (+ ?c (min ?b ?a))) if (< ?c 0)
// (< (+ ?d ?c) (min ?b ?a)) ==> (< (+ ?d ?c) (min ?c (min ?b ?a))) if (< ?d 0)
// (< (+ ?d ?c) (min ?c (min ?b ?a))) ==> (< (+ ?d ?c) (min ?b ?a)) if (< ?d 0)
// (< (min ?d (+ ?b ?c)) ?a) ==> (< (min ?d (+ ?b ?c)) (min ?b ?a)) if (< ?c 0)
// (< (min ?d (+ ?b ?c)) (min ?b ?a)) ==> (< (min ?d (+ ?b ?c)) ?a) if (< ?c 0)
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (min ?d ?c) (+ ?a (min ?d ?b))) if (< 0 ?a)
// (< (min ?d ?c) (+ ?a (min ?d ?b))) ==> (< (min ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< (min ?c ?b) (+ ?b (min ?a ?d))) ==> (< (min ?c ?b) (+ ?b ?a)) if (< 0 ?d)
// (< (min ?d ?c) (+ ?b ?a)) ==> (< (min ?d ?c) (+ ?a (min ?c ?b))) if (< 0 ?a)
// (< (min ?d ?c) (+ ?a (min ?c ?b))) ==> (< (min ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< (min ?c ?b) (min ?a (+ ?b ?d))) ==> (< (min ?c ?b) ?a) if (< 0 ?d)
// (< (+ ?c ?b) (min ?a (+ ?a ?d))) ==> (< (+ ?c ?b) ?a) if (< 0 ?d)
// (< (min ?c (+ ?b ?d)) (min ?c (min ?b ?a))) ==> 0 if (< 0 ?d)
// (< (+ ?d (min ?c ?b)) (min ?c (min ?b ?a))) ==> 0 if (< 0 ?d)
// (< (+ ?c (+ ?b ?d)) (+ ?c (min ?b ?a))) ==> 0 if (< 0 ?d)
// (< (min ?d (min ?b ?a)) (+ ?c (min ?b ?a))) ==> 1 if (< 0 ?c)
...
// (< (max ?b ?a) (+ ?b (+ ?a ?a))) ==> (< (max ?b (+ ?b ?b)) (+ ?a (+ ?b ?b)))
// (< (max ?b (+ ?b ?b)) (+ ?a (+ ?b ?b))) ==> (< (max ?b ?a) (+ ?b (+ ?a ?a)))
// (< (+ ?c (+ ?b ?a)) (+ ?b (+ ?b ?a))) ==> (< (max ?c (+ ?c ?c)) (max ?b (+ ?b ?b)))
// (< (+ ?b (max ?a ?c)) (+ ?a (max ?a ?c))) ==> (< (max ?b (+ ?b ?b)) (max ?a (+ ?a ?a)))
// (< (+ ?c (+ ?b ?b)) (+ ?c (max ?b ?a))) ==> (< (+ ?c (+ ?b ?b)) (max ?c (+ ?c ?a)))
// (< (+ ?c (+ ?b ?b)) (max ?c (+ ?c ?a))) ==> (< (+ ?c (+ ?b ?b)) (+ ?c (max ?b ?a)))
// (< (+ ?b (max ?b ?c)) (max ?b (+ ?b ?a))) ==> (< (+ ?a (max ?b ?c)) (max ?a (+ ?a ?a)))
// (< (+ ?a (max ?b ?c)) (max ?a (+ ?a ?a))) ==> (< (+ ?b (max ?b ?c)) (max ?b (+ ?b ?a)))
// (< (+ ?b (max ?c ?a)) (+ ?b (+ ?a ?a))) ==> (< (max ?b (+ ?b ?c)) (+ ?b (+ ?a ?a)))
// (< (max ?b (+ ?b ?c)) (+ ?b (+ ?a ?a))) ==> (< (+ ?b (max ?c ?a)) (+ ?b (+ ?a ?a)))
// (< (+ ?c (+ ?b ?b)) (max ?b (+ ?b ?a))) ==> (< (+ ?b (+ ?c ?a)) (max ?a (+ ?a ?a)))
// (< (+ ?b (+ ?c ?a)) (max ?a (+ ?a ?a))) ==> (< (+ ?c (+ ?b ?b)) (max ?b (+ ?b ?a)))
// (< (max ?c ?b) (+ ?b (+ ?a ?a))) ==> (< (max ?c (+ ?b ?a)) (+ ?b (+ ?a ?a)))
// (< (max ?c (+ ?b ?a)) (+ ?b (+ ?a ?a))) ==> (< (max ?c ?b) (+ ?b (+ ?a ?a)))
// (< (+ ?b (+ ?c ?a)) (+ ?b (+ ?b ?a))) ==> (< (+ ?c (max ?b ?c)) (+ ?b ?b))
// (< (+ ?c ?c) (+ ?b (max ?c ?a))) ==> (< (+ ?c (max ?c ?b)) (+ ?b (max ?b ?a)))
// (< (+ ?c (max ?c ?b)) (+ ?b (max ?b ?a))) ==> (< (+ ?c ?c) (+ ?b (max ?c ?a)))
// (< (+ ?b (+ ?a ?c)) (max ?c (+ ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a))
// (< (+ ?c ?c) (max ?b (+ ?a ?a))) ==> (< (+ ?c (max ?c ?a)) (max ?b (+ ?a ?a)))
// (< (+ ?c (max ?c ?a)) (max ?b (+ ?a ?a))) ==> (< (+ ?c ?c) (max ?b (+ ?a ?a)))
// (< (+ ?b (+ ?a ?a)) (max ?b ?c)) ==> (< (+ ?b (+ ?a ?a)) (max ?c (+ ?b ?a)))
// (< (+ ?b (+ ?a ?a)) (max ?c (+ ?b ?a))) ==> (< (+ ?b (+ ?a ?a)) (max ?b ?c))
// (< (max ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (max ?c (+ ?b ?b)) (+ ?a (max ?b ?a)))
...
// (< (+ ?b ?b) (max ?c (+ ?a ?a))) ==> (< (+ ?b ?b) (max ?c (+ ?b ?a)))
// (< (+ ?c (max ?c ?b)) (+ ?a ?a)) ==> (< (+ ?c (max ?b ?a)) (+ ?a ?a))
// (< (+ ?c (max ?b ?a)) (+ ?a ?a)) ==> (< (+ ?c (max ?c ?b)) (+ ?a ?a))
// (< (max ?c (+ ?b ?a)) (+ ?a ?a)) ==> (< (max ?c (+ ?b ?b)) (+ ?a ?a))
// (< (max ?c (+ ?b ?b)) (+ ?a ?a)) ==> (< (max ?c (+ ?b ?a)) (+ ?a ?a))
// (< (+ ?c ?c) (+ ?a (max ?b ?a))) ==> (< (+ ?c ?c) (+ ?a (max ?c ?b)))
// (< (+ ?c ?c) (+ ?a (max ?c ?b))) ==> (< (+ ?c ?c) (+ ?a (max ?b ?a)))
// (< (+ ?c ?b) (+ ?b ?a)) ==> (< (+ ?c (max ?c ?b)) (+ ?a (max ?b ?a)))
// (< (+ ?c (max ?c ?b)) (+ ?a (max ?b ?a))) ==> (< (+ ?c ?b) (+ ?b ?a))
// (< (+ ?b (+ ?a ?c)) (+ ?c (max ?b ?a))) ==> (< (+ ?b ?a) (max ?b ?a))
// (< (max ?b ?c) (+ ?b ?a)) ==> (< (max ?b (+ ?c ?a)) (+ ?b (+ ?a ?a)))
// (< (max ?b (+ ?c ?a)) (+ ?b (+ ?a ?a))) ==> (< (max ?b ?c) (+ ?b ?a))
// (< (+ ?c (max ?b ?a)) (+ ?b (+ ?a ?c))) ==> (< (max ?b ?a) (+ ?b ?a))
// (< (+ ?c (max ?a ?b)) (max ?c (+ ?a ?c))) ==> (< (+ ?a (max ?a ?b)) ?a)
// (< (+ ?c ?b) (max ?c ?a)) ==> (< (+ ?c (+ ?b ?b)) (max ?c (+ ?b ?a)))
// (< (+ ?c (+ ?b ?b)) (max ?c (+ ?b ?a))) ==> (< (+ ?c ?b) (max ?c ?a))
// (< (+ ?c (max ?b ?a)) (+ ?a (+ ?a ?c))) ==> (< (max ?b ?a) (+ ?a ?a))
// (< (+ ?b (max ?a ?c)) (+ ?a (max ?a ?c))) ==> (< ?b (max ?b ?a))
// (< (max ?b (max ?a ?c)) ?c) ==> (< (max ?b ?a) ?a)
// (< (+ ?b (+ ?c ?d)) (+ ?c (+ ?b ?a))) ==> (< (+ ?d (max ?b ?c)) (+ ?a (max ?b ?c)))
// (< (+ ?d (max ?b ?c)) (+ ?a (max ?b ?c))) ==> (< (+ ?b (+ ?c ?d)) (+ ?c (+ ?b ?a)))
// (< (+ ?b (max ?d ?c)) (+ ?b ?a)) ==> (< (+ ?b (max ?d ?c)) (+ ?b (max ?c ?a)))
// (< (+ ?b (max ?d ?c)) (+ ?b (max ?c ?a))) ==> (< (+ ?b (max ?d ?c)) (+ ?b ?a))
// (< (+ ?b (max ?d ?c)) (+ ?c ?a)) ==> (< (+ ?b (max ?d ?c)) (+ ?c (max ?b ?a)))
// (< (+ ?b (max ?d ?c)) (+ ?c (max ?b ?a))) ==> (< (+ ?b (max ?d ?c)) (+ ?c ?a))
// (< (max ?d (+ ?b ?c)) (+ ?b ?a)) ==> (< (max ?d (+ ?b ?c)) (+ ?b (max ?c ?a)))
// (< (max ?d (+ ?b ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?d (+ ?b ?c)) (+ ?b ?a))
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (+ ?c (max ?d ?c)) (+ ?c (+ ?b ?a)))
// (< (+ ?c (max ?d ?c)) (+ ?c (+ ?b ?a))) ==> (< (max ?d ?c) (+ ?b ?a))
// (< (+ ?d ?c) (max ?b ?a)) ==> (< (+ ?d (+ ?c ?b)) (+ ?b (max ?b ?a)))
// (< (+ ?d (+ ?c ?b)) (+ ?b (max ?b ?a))) ==> (< (+ ?d ?c) (max ?b ?a))
// (< (+ ?b (max ?a ?d)) ?c) ==> (< (+ ?b (max ?a ?d)) (max ?c (+ ?b ?a)))
// (< (+ ?b (max ?a ?d)) (max ?c (+ ?b ?a))) ==> (< (+ ?b (max ?a ?d)) ?c)
// (< (max ?d (+ ?c ?b)) ?a) ==> (< (max ?d (+ ?c ?b)) (max ?d ?a))
// (< (max ?d (+ ?c ?b)) (max ?d ?a)) ==> (< (max ?d (+ ?c ?b)) ?a)
// (< ?b (+ ?a (+ ?a ?a))) ==> (< (max ?b (+ ?b ?b)) (+ ?a (+ ?a ?a))) if (< ?a 0)
// (< (max ?b (+ ?b ?b)) (+ ?a (+ ?a ?a))) ==> (< ?b (+ ?a (+ ?a ?a))) if (< ?a 0)
// (< ?b (+ ?a (max ?b ?a))) ==> (< (+ ?b (max ?b ?a)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (max ?b ?a)) (+ ?a (+ ?a ?a))) ==> (< ?b (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?b ?b)) ?a) ==> (< (+ ?b (+ ?b ?b)) (max ?a (+ ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?b ?b)) (max ?a (+ ?b ?a))) ==> (< (+ ?b (+ ?b ?b)) ?a) if (< ?a 0)
// (< ?a (+ ?b (+ ?a ?a))) ==> (< (max ?b (+ ?a ?a)) (+ ?a (+ ?b ?b))) if (< ?a 0)
// (< (max ?b (+ ?a ?a)) (+ ?a (+ ?b ?b))) ==> (< ?a (+ ?b (+ ?a ?a))) if (< ?a 0)
// (< ?b (+ ?a (+ ?a ?a))) ==> (< (max ?b (+ ?b ?a)) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (max ?b (+ ?b ?a)) (+ ?a (+ ?a ?a))) ==> (< ?b (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b ?b) ?a) ==> (< (+ ?b (+ ?b ?b)) (+ ?a (max ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?b ?b)) (+ ?a (max ?b ?a))) ==> (< (+ ?b ?b) ?a) if (< ?a 0)
// (< (+ ?b (+ ?b ?b)) (max ?b ?a)) ==> (< (+ ?b ?b) ?b) if (< ?a 0)
// (max ?a (+ ?a ?b)) ==> ?a if (< ?b 0)
// (< (max ?b (max ?c ?a)) (+ ?b (+ ?b ?a))) ==> (< (max ?b (+ ?c ?c)) (+ ?c (+ ?b ?b))) if (< ?b 0)
// (< (max ?b (max ?c ?a)) (+ ?b (max ?b ?a))) ==> (< (max ?b (+ ?c ?c)) (+ ?b (+ ?b ?b))) if (< ?c 0)
// (< (+ ?b (+ ?a ?c)) (+ ?a (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?c (max ?b ?a)) (+ ?b (+ ?a ?a))) ==> (< (max ?c (+ ?c ?b)) (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?c (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< (max ?c (max ?b ?a)) (+ ?b (+ ?a ?a))) if (< ?c 0)
// (< (max ?c (+ ?b ?b)) (max ?a (+ ?b ?a))) ==> (< (max ?c (+ ?b ?b)) (max ?a (+ ?a ?a))) if (< ?c 0)
// (< (max ?c (+ ?b ?b)) (max ?a (+ ?a ?a))) ==> (< (max ?c (+ ?b ?b)) (max ?a (+ ?b ?a))) if (< ?c 0)
// (< (max ?c (+ ?c ?c)) (max ?a (+ ?b ?a))) ==> (< (max ?c (+ ?c ?c)) (max ?a (+ ?c ?b))) if (< ?b 0)
// (< (max ?c (+ ?c ?c)) (max ?a (+ ?c ?b))) ==> (< (max ?c (+ ?c ?c)) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?a (+ ?b ?c)) (+ ?a (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (max ?c ?b)) (max ?a (+ ?a ?a))) ==> (< (+ ?b (max ?c ?b)) (max ?a (+ ?b ?a))) if (< ?c 0)
// (< (+ ?b (max ?c ?b)) (max ?a (+ ?b ?a))) ==> (< (+ ?b (max ?c ?b)) (max ?a (+ ?a ?a))) if (< ?c 0)
// (< (+ ?c (max ?c ?b)) (max ?b (+ ?a ?a))) ==> (< (+ ?c (max ?b ?a)) (max ?b (+ ?a ?a))) if (< 0 ?a)
// (< (+ ?c (max ?b ?a)) (max ?b (+ ?a ?a))) ==> (< (+ ?c (max ?c ?b)) (max ?b (+ ?a ?a))) if (< 0 ?a)
// (< (max ?a (+ ?b ?c)) (max ?c (+ ?a ?c))) ==> (< (+ ?b (max ?a ?b)) (max ?b (+ ?a ?a))) if (< 0 ?c)
// (< (+ ?a (max ?c ?b)) (+ ?a (+ ?a ?a))) ==> (< (max ?a (max ?c ?b)) (max ?b (+ ?a ?a))) if (< 0 ?b)
// (< (max ?a (max ?c ?b)) (max ?b (+ ?a ?a))) ==> (< (+ ?a (max ?c ?b)) (+ ?a (+ ?a ?a))) if (< 0 ?b)
// (< (max ?c (+ ?c ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?c (+ ?c ?c)) (+ ?b (max ?c ?a))) if (< 0 ?a)
// (< (max ?c (+ ?c ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?c (+ ?c ?c)) (+ ?b (max ?b ?a))) if (< 0 ?a)
// (< (max ?b (+ ?c ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?b (+ ?c ?c)) (+ ?b (max ?c ?a))) if (< 0 ?a)
// (< (max ?b (+ ?c ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?b (+ ?c ?c)) (+ ?b (max ?b ?a))) if (< 0 ?a)
// (< (max ?c (max ?b ?a)) (+ ?b (+ ?b ?a))) ==> (< (max ?c (+ ?b ?a)) (+ ?b (+ ?b ?a))) if (< 0 ?a)
// (< (max ?c (+ ?b ?a)) (+ ?b (+ ?b ?a))) ==> (< (max ?c (max ?b ?a)) (+ ?b (+ ?b ?a))) if (< 0 ?a)
// (< (max ?c (+ ?b ?b)) (+ ?b ?a)) ==> (< (max ?c (+ ?b ?b)) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?c (+ ?b ?b)) (+ ?b (max ?c ?a))) ==> (< (max ?c (+ ?b ?b)) (+ ?b ?a)) if (< ?c 0)
// (< (+ ?b (+ ?a ?c)) (+ ?a (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?a (+ ?b ?c)) (+ ?b ?a)) ==> (< (max ?b (max ?c ?a)) (+ ?b (+ ?b ?b))) if (< ?b 0)
// (< (max ?b (max ?c ?a)) (+ ?b (+ ?b ?b))) ==> (< (max ?a (+ ?b ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?c ?c) (max ?c (+ ?b ?a))) ==> (< (+ ?c (max ?c ?b)) (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c (max ?c ?b)) (max ?c (+ ?b ?a))) ==> (< (+ ?c ?c) (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b ?c) (max ?b (+ ?a ?a))) ==> (< (+ ?b (max ?c ?a)) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (max ?c ?a)) (max ?b (+ ?a ?a))) ==> (< (+ ?b ?c) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?c (+ ?c ?c)) (+ ?b ?a)) ==> (< (max ?c (+ ?c ?c)) (+ ?b (max ?c ?a))) if (< ?b 0)
// (< (max ?c (+ ?c ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?c (+ ?c ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (max ?c (max ?b ?a)) (+ ?b ?a)) ==> (< (+ ?c (max ?b ?a)) (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?c (max ?b ?a)) (+ ?c (+ ?b ?a))) ==> (< (max ?c (max ?b ?a)) (+ ?b ?a)) if (< ?c 0)
// (< (+ ?b (max ?a ?c)) (max ?b (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?b ?a) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?a ?c)) (+ ?c (max ?a ?c))) if (< ?b 0)
// (< (max ?b (max ?a ?c)) (+ ?c (max ?a ?c))) ==> (< (max ?b ?a) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) (+ ?b ?b)) ==> (< (max ?a (+ ?c ?b)) (+ ?b (max ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) (+ ?b (max ?b ?a))) ==> (< (max ?a (+ ?c ?b)) (+ ?b ?b)) if (< ?b 0)
// (< (max ?b (+ ?c ?c)) (+ ?b ?a)) ==> (< (max ?b (+ ?c ?c)) (+ ?b (max ?c ?a))) if (< ?b 0)
// (< (max ?b (+ ?c ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?b (+ ?c ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b (max ?a ?c)) (max ?b ?a)) ==> (< (+ ?b (+ ?a ?c)) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (+ ?a (max ?b ?a))) ==> (< (+ ?b (max ?a ?c)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?b (+ ?a ?a)) (max ?c (+ ?a ?a))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (max ?a (+ ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?c (max ?c ?b)) (max ?c ?a)) ==> (< (+ ?b (+ ?c ?c)) (max ?b (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?c ?c)) (max ?b (+ ?b ?a))) ==> (< (+ ?c (max ?c ?b)) (max ?c ?a)) if (< ?b 0)
// (< (max ?b (max ?a ?c)) (+ ?a (max ?a ?c))) ==> (< (max ?b ?a) (+ ?a (+ ?a ?a))) if (< ?b 0)
// (< (+ ?c ?b) (max ?b (+ ?b ?a))) ==> (< (+ ?c (max ?c ?b)) (max ?c (+ ?a ?a))) if (< ?b 0)
// (< (+ ?c (max ?c ?b)) (max ?c (+ ?a ?a))) ==> (< (+ ?c ?b) (max ?b (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c (+ ?b ?a)) (max ?b ?a)) ==> (< (+ ?c (+ ?b ?a)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (+ ?c (+ ?b ?a)) (max ?c (max ?b ?a))) ==> (< (+ ?c (+ ?b ?a)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?a (max ?c ?b)) (max ?b ?a)) ==> (< (+ ?c (+ ?b ?a)) (+ ?b (max ?b ?a))) if (< ?b 0)
// (< (+ ?c (+ ?b ?a)) (+ ?b (max ?b ?a))) ==> (< (+ ?a (max ?c ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?b ?a) (+ ?c (max ?b ?a))) ==> (< (max ?a (+ ?b ?a)) (+ ?a (+ ?c ?c))) if (< ?b 0)
// (< (max ?a (+ ?b ?a)) (+ ?a (+ ?c ?c))) ==> (< (max ?b ?a) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?b ?c)) (+ ?b ?a)) ==> (< (max ?b (+ ?c ?a)) (+ ?b (+ ?c ?a))) if (< ?b 0)
// (< (max ?b (+ ?c ?a)) (+ ?b (+ ?c ?a))) ==> (< (max ?a (+ ?b ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (max ?b (+ ?c ?b)) (+ ?b ?a)) ==> (< (max ?c (+ ?c ?c)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c (+ ?c ?c)) (+ ?c (max ?b ?a))) ==> (< (max ?b (+ ?c ?b)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b ?c) (max ?a (+ ?b ?a))) ==> (< (+ ?b (+ ?c ?c)) (+ ?a (max ?c ?a))) if (< ?b 0)
// (< (+ ?b (+ ?c ?c)) (+ ?a (max ?c ?a))) ==> (< (+ ?b ?c) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?a (+ ?b ?b)) (max ?b (max ?a ?c))) ==> (< (+ ?b (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?b (max ?c ?a)) (max ?b ?a)) ==> (< (+ ?b (max ?c ?a)) (max ?b (max ?c ?a))) if (< ?c 0)
// (< (+ ?b (max ?c ?a)) (max ?b (max ?c ?a))) ==> (< (+ ?b (max ?c ?a)) (max ?b ?a)) if (< ?c 0)
// (< (max ?c (max ?a ?b)) (+ ?a ?a)) ==> (< (+ ?c (max ?a ?b)) (+ ?c (+ ?a ?a))) if (< ?c 0)
// (< (+ ?c (max ?a ?b)) (+ ?c (+ ?a ?a))) ==> (< (max ?c (max ?a ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (+ ?c (+ ?b ?b)) (max ?b ?a)) ==> (< (+ ?c (+ ?b ?b)) (max ?b (max ?c ?a))) if (< ?c 0)
// (< (+ ?c (+ ?b ?b)) (max ?b (max ?c ?a))) ==> (< (+ ?c (+ ?b ?b)) (max ?b ?a)) if (< ?c 0)
// (< (max ?b (max ?a ?c)) (+ ?a (max ?a ?c))) ==> (< (max ?a (+ ?b ?b)) (+ ?a ?a)) if (< ?b 0)
// (< (+ ?c (+ ?c ?c)) (max ?b ?a)) ==> (< (+ ?c (+ ?c ?c)) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (+ ?c (+ ?c ?c)) (max ?c (max ?b ?a))) ==> (< (+ ?c (+ ?c ?c)) (max ?b ?a)) if (< 0 ?a)
// (< (max ?a (+ ?b ?c)) (max ?c (+ ?a ?c))) ==> (< (+ ?a ?b) (max ?a (+ ?a ?a))) if (< 0 ?c)
// (< (+ ?c ?c) (+ ?b (+ ?b ?a))) ==> (< (+ ?c (max ?c ?b)) (+ ?b (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?c (max ?c ?b)) (+ ?b (+ ?b ?a))) ==> (< (+ ?c ?c) (+ ?b (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?b ?b) (+ ?c (max ?b ?a))) ==> (< (max ?b (+ ?b ?b)) (+ ?c (max ?a ?c))) if (< 0 ?c)
// (< (max ?b (+ ?b ?b)) (+ ?c (max ?a ?c))) ==> (< (+ ?b ?b) (+ ?c (max ?b ?a))) if (< 0 ?c)
// (< (max ?a (max ?c ?b)) (+ ?a ?a)) ==> (< (+ ?a (max ?c ?b)) (+ ?a (+ ?a ?a))) if (< 0 ?b)
// (< (+ ?a (max ?c ?b)) (+ ?a (+ ?a ?a))) ==> (< (max ?a (max ?c ?b)) (+ ?a ?a)) if (< 0 ?b)
// (< (+ ?b ?c) (max ?b ?a)) ==> (< (+ ?b (+ ?c ?c)) (max ?c (+ ?b ?b))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c (+ ?a ?a)) (+ ?a (+ ?c ?c))) if (< ?c 0)
// (< (+ ?b (max ?c ?a)) (max ?b ?a)) ==> (< (+ ?a (max ?b ?c)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?a (max ?b ?c)) (max ?b ?a)) ==> (< (+ ?b (max ?c ?a)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?c ?c) (max ?a (+ ?b ?a))) ==> (< (+ ?b (+ ?c ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b (+ ?c ?c)) (+ ?b ?a)) ==> (< (+ ?c ?c) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b ?a) (max ?b (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?c ?b) (max ?b (+ ?b ?a))) ==> (< (max ?c ?b) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?b (max ?c ?a))) ==> (< (max ?c ?b) (max ?b (+ ?b ?a))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a (+ ?c ?c)) (+ ?c (+ ?a ?a))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?b (+ ?c ?c)) (+ ?c (+ ?b ?b))) if (< ?b 0)
// (< (max ?c ?b) (max ?c (+ ?c ?a))) ==> (< (max ?c ?b) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (+ ?c (max ?b ?a))) ==> (< (max ?c ?b) (max ?c (+ ?c ?a))) if (< ?b 0)
// (< (max ?b (max ?a ?c)) (+ ?b ?a)) ==> (< (max ?b ?a) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c ?b) (max ?b ?a)) ==> (< (+ ?b (+ ?c ?c)) (max ?c (+ ?b ?b))) if (< ?c 0)
// (< (max ?c (+ ?b ?c)) (max ?b ?a)) ==> (< (+ ?b ?c) (+ ?b (max ?b ?a))) if (< ?c 0)
// (< (+ ?b ?c) (+ ?b (max ?b ?a))) ==> (< (max ?c (+ ?b ?c)) (max ?b ?a)) if (< ?c 0)
// (< (max ?c ?b) (max ?b (+ ?b ?a))) ==> (< (max ?c ?b) (+ ?b (max ?c ?a))) if (< ?b 0)
// (< (max ?c ?b) (+ ?b (max ?c ?a))) ==> (< (max ?c ?b) (max ?b (+ ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (max ?b (+ ?c ?a))) ==> (< (max ?c ?b) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?c (max ?b ?a))) ==> (< (max ?c ?b) (max ?b (+ ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?b (max ?c ?a))) ==> (< (max ?c ?b) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?c ?b) (max ?c (+ ?b ?a))) ==> (< (max ?c ?b) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c (+ ?b ?b)) (+ ?b (+ ?c ?c))) if (< ?c 0)
// (< (+ ?b ?b) (max ?b (max ?c ?a))) ==> (< (+ ?b (max ?b ?c)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?b (max ?b ?c)) (max ?b ?a)) ==> (< (+ ?b ?b) (max ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?a (max ?c ?a))) ==> (< (max ?c ?b) (max ?b (+ ?a ?a))) if (< ?c 0)
// (< (max ?c ?b) (max ?b (+ ?a ?a))) ==> (< (max ?c ?b) (+ ?a (max ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?a (max ?b ?a))) ==> (< (max ?c ?b) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?c ?b) (max ?b (+ ?a ?a))) ==> (< (max ?c ?b) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (max ?b (+ ?c ?a))) ==> (< (max ?c ?b) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (+ ?c (max ?b ?a))) ==> (< (max ?c ?b) (max ?b (+ ?c ?a))) if (< ?b 0)
// (< (+ ?b ?a) (+ ?a ?c)) ==> (< (max ?b (+ ?b ?a)) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?b (+ ?b ?a)) (max ?c (+ ?b ?a))) ==> (< (+ ?b ?a) (+ ?a ?c)) if (< ?a 0)
// (< ?c (max ?b (+ ?a ?a))) ==> (< (max ?c (+ ?c ?a)) (max ?b (+ ?a ?a))) if (< ?c 0)
// (< (max ?c (+ ?c ?a)) (max ?b (+ ?a ?a))) ==> (< ?c (max ?b (+ ?a ?a))) if (< ?c 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b (max ?a ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c (max ?b ?a)) (max ?c (+ ?c ?b))) if (< ?c 0)
// (< (max ?c (max ?b ?a)) (max ?c (+ ?c ?b))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?c 0)
// (< (+ ?b (max ?a ?c)) (+ ?b (+ ?a ?a))) ==> (< ?b (max ?b (+ ?b ?a))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (+ ?a (max ?c ?b)) (+ ?a (+ ?c ?b))) if (< ?c 0)
// (< (+ ?a (max ?c ?b)) (+ ?a (+ ?c ?b))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?c 0)
// (< (max ?b (max ?c ?a)) (+ ?b (max ?b ?a))) ==> (< ?b (max ?b (+ ?b ?b))) if (< ?c 0)
// (< ?c (+ ?c (max ?b ?a))) ==> (< (max ?b (+ ?c ?b)) (+ ?b (max ?b ?a))) if (< ?c 0)
// (< (max ?b (+ ?c ?b)) (+ ?b (max ?b ?a))) ==> (< ?c (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (+ ?a (+ ?b ?b)) (max ?b (max ?a ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?b 0)
// (< (max ?b (max ?c ?a)) (+ ?b (max ?b ?a))) ==> (< ?b (+ ?b (max ?b ?c))) if (< ?c 0)
// (< ?c (+ ?c (+ ?b ?a))) ==> (< (max ?c (+ ?c ?b)) (+ ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?c (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< ?c (+ ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (+ ?a (max ?c ?b)) (+ ?a (+ ?c ?c))) if (< ?c 0)
// (< (+ ?a (max ?c ?b)) (+ ?a (+ ?c ?c))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?c 0)
// (< (max ?b (max ?a ?c)) (+ ?a (+ ?a ?c))) ==> (< ?b (max ?b (+ ?b ?a))) if (< ?a 0)
// (< (max ?c (+ ?b ?a)) ?a) ==> (< (+ ?b (+ ?a ?c)) (+ ?b (+ ?a ?a))) if (< ?b 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b (+ ?a ?a))) ==> (< (max ?c (+ ?b ?a)) ?a) if (< ?b 0)
// (< ?b (+ ?b (max ?c ?a))) ==> (< (max ?b (+ ?b ?c)) (+ ?b (+ ?a ?a))) if (< ?c 0)
// (< (max ?b (+ ?b ?c)) (+ ?b (+ ?a ?a))) ==> (< ?b (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (+ ?c (max ?b ?a)) (+ ?b (+ ?c ?c))) if (< ?c 0)
// (< (+ ?c (max ?b ?a)) (+ ?b (+ ?c ?c))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?c 0)
// (< (+ ?a (max ?c ?b)) (+ ?a (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?c 0)
// (< (+ ?a (+ ?b ?b)) (max ?b (max ?a ?c))) ==> (< (+ ?b ?b) (max ?b ?a)) if (< ?b 0)
// (< ?b (+ ?c (max ?b ?a))) ==> (< (max ?b (+ ?b ?a)) (+ ?c (max ?b ?a))) if (< ?a 0)
// (< (max ?b (+ ?b ?a)) (+ ?c (max ?b ?a))) ==> (< ?b (+ ?c (max ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?a ?c)) (+ ?a (max ?b ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?b 0)
// (< ?c (+ ?c (+ ?b ?a))) ==> (< (max ?b (+ ?c ?b)) (+ ?b (+ ?b ?a))) if (< ?c 0)
// (< (max ?b (+ ?c ?b)) (+ ?b (+ ?b ?a))) ==> (< ?c (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< ?c (max ?b (+ ?a ?a))) ==> (< (max ?c (+ ?b ?a)) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?c (+ ?b ?a)) (max ?b (+ ?a ?a))) ==> (< ?c (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?c (+ ?b ?b)) ?a) ==> (< (max ?c (+ ?b ?b)) (max ?a (+ ?b ?c))) if (< ?c 0)
// (< (max ?c (+ ?b ?b)) (max ?a (+ ?b ?c))) ==> (< (max ?c (+ ?b ?b)) ?a) if (< ?c 0)
// (< (max ?c (+ ?b ?a)) (+ ?a (+ ?a ?c))) ==> (< ?b (max ?b (+ ?b ?a))) if (< ?a 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b (max ?b ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< ?c (+ ?b (max ?b ?a))) ==> (< (max ?c (+ ?c ?b)) (+ ?b (max ?b ?a))) if (< ?c 0)
// (< (max ?c (+ ?c ?b)) (+ ?b (max ?b ?a))) ==> (< ?c (+ ?b (max ?b ?a))) if (< ?c 0)
// (< (+ ?a (max ?b ?c)) (+ ?a (+ ?b ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a (max ?c ?b)) (+ ?a (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (max ?c ?b)) (+ ?a (+ ?c ?c))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) (max ?c (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< 0 ?b)
// (< (max ?b (max ?a ?c)) (+ ?c (max ?b ?a))) ==> (< ?b (+ ?b (max ?b ?a))) if (< 0 ?c)
// (< (max ?a (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< ?c (+ ?b (+ ?c ?c))) if (< 0 ?a)
// (< (+ ?a (+ ?b ?c)) (max ?c (+ ?a ?b))) ==> (< (+ ?b (+ ?a ?a)) ?a) if (< 0 ?c)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (max ?c (+ ?a ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (max ?c (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c ?b) (max ?b (+ ?c ?b))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?a (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?c (+ ?a ?a))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c ?b) (+ ?b (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (max ?c (+ ?a ?a))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c ?b) (max ?b (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (max ?c (+ ?a ?c))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (max ?a (+ ?a ?c))) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a (+ ?c ?c)) (+ ?a ?c)) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c (+ ?a ?a)) (+ ?a ?c)) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?c ?b) (+ ?c (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?c (+ ?c ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?a (+ ?a ?a))) if (< ?a 0)
// (< (max ?c (+ ?b ?a)) (+ ?a ?c)) ==> (< ?b (max ?b (+ ?b ?a))) if (< ?a 0)
// (< (+ ?b (max ?a ?c)) ?b) ==> (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) if (< ?a 0)
// (< (+ ?b (+ ?a ?c)) (+ ?b ?a)) ==> (< (+ ?b (max ?a ?c)) ?b) if (< ?a 0)
// (< (max ?b (max ?c ?a)) (+ ?b (max ?b ?a))) ==> (< ?b (+ ?b ?b)) if (< ?c 0)
// (< ?b (+ ?b (max ?a ?c))) ==> (< (max ?b ?a) (+ ?c (max ?b ?a))) if (< ?a 0)
// (< (max ?b ?a) (+ ?c (max ?b ?a))) ==> (< ?b (+ ?b (max ?a ?c))) if (< ?a 0)
// (< (max ?c ?b) (+ ?b ?a)) ==> (< (max ?c ?b) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?b (max ?c ?a))) ==> (< (max ?c ?b) (+ ?b ?a)) if (< ?c 0)
// (< (+ ?c ?c) (max ?b ?a)) ==> (< (+ ?c (max ?c ?b)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?c (max ?c ?b)) (max ?b ?a)) ==> (< (+ ?c ?c) (max ?b ?a)) if (< ?b 0)
// (< (+ ?b (+ ?a ?a)) (max ?b ?c)) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< (+ ?c (max ?a ?b)) ?a) ==> (< (+ ?c (+ ?a ?b)) (+ ?a ?a)) if (< ?c 0)
// (< (+ ?c (+ ?a ?b)) (+ ?a ?a)) ==> (< (+ ?c (max ?a ?b)) ?a) if (< ?c 0)
// (< (max ?c ?b) (+ ?c ?a)) ==> (< (max ?c ?b) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (+ ?c (max ?b ?a))) ==> (< (max ?c ?b) (+ ?c ?a)) if (< ?b 0)
// (< ?c (max ?c (max ?b ?a))) ==> (< (max ?c (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?c (+ ?b ?b)) (max ?b ?a)) ==> (< ?c (max ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c ?b) (+ ?a ?a)) ==> (< (max ?c ?b) (+ ?a (max ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (+ ?a (max ?c ?a))) ==> (< (max ?c ?b) (+ ?a ?a)) if (< ?c 0)
// (< (+ ?b ?c) ?a) ==> (< (+ ?c (+ ?b ?b)) (+ ?a (max ?b ?a))) if (< ?c 0)
// (< (+ ?c (+ ?b ?b)) (+ ?a (max ?b ?a))) ==> (< (+ ?b ?c) ?a) if (< ?c 0)
// (< (+ ?a (+ ?b ?c)) (+ ?a (max ?b ?c))) ==> (< (+ ?a ?b) ?a) if (< 0 ?c)
// (< (max ?a (+ ?b ?c)) (+ ?a ?c)) ==> (< (+ ?a ?b) (+ ?a ?a)) if (< 0 ?c)
// (< (+ ?b (max ?a ?c)) (+ ?b (+ ?a ?c))) ==> (< ?b (+ ?b ?a)) if (< 0 ?c)
// (< (+ ?c (max ?a ?b)) (max ?b ?c)) ==> (< (+ ?a (max ?a ?b)) ?a) if (< 0 ?c)
// (< (+ ?c ?c) (max ?b ?a)) ==> (< (+ ?c ?c) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (+ ?c ?c) (max ?c (max ?b ?a))) ==> (< (+ ?c ?c) (max ?b ?a)) if (< 0 ?a)
// (< (max ?c ?b) ?a) ==> (< (+ ?a (max ?c ?b)) (max ?b (+ ?a ?a))) if (< 0 ?a)
// (< (+ ?a (max ?c ?b)) (max ?b (+ ?a ?a))) ==> (< (max ?c ?b) ?a) if (< 0 ?a)
// (< ?c (max ?b ?a)) ==> (< (max ?b (+ ?c ?b)) (+ ?b (max ?b ?a))) if (< 0 ?a)
// (< (max ?b (+ ?c ?b)) (+ ?b (max ?b ?a))) ==> (< ?c (max ?b ?a)) if (< 0 ?a)
// (< (max ?a (max ?c ?b)) (+ ?a (max ?c ?b))) ==> (< ?a (+ ?a ?a)) if (< 0 ?b)
// (< (max ?b (max ?a ?c)) (+ ?a (max ?b ?c))) ==> (< ?b (+ ?b ?a)) if (< 0 ?c)
// (< (+ ?b (max ?c ?b)) ?a) ==> (< (+ ?b (max ?c ?b)) (max ?b ?a)) if (< 0 ?a)
// (< (+ ?b (max ?c ?b)) (max ?b ?a)) ==> (< (+ ?b (max ?c ?b)) ?a) if (< 0 ?a)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?c ?c)) if (< ?c 0)
// (< (+ ?b ?a) (max ?b ?c)) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< ?a (max ?a (+ ?a ?c))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?a ?c)) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< ?c (max ?c (+ ?c ?c))) if (< ?c 0)
// (< (max ?c (+ ?b ?c)) ?a) ==> (< (+ ?b ?c) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?b ?c) (+ ?b ?a)) ==> (< (max ?c (+ ?b ?c)) ?a) if (< ?b 0)
// (< (max ?c (+ ?c ?b)) ?a) ==> (< ?c (max ?a (+ ?c ?b))) if (< ?b 0)
// (< ?c (max ?a (+ ?c ?b))) ==> (< (max ?c (+ ?c ?b)) ?a) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< ?c (max ?c (+ ?c ?b))) if (< ?b 0)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (max ?a ?c) (+ ?a ?c)) if (< ?a 0)
// (< ?c (+ ?b ?a)) ==> (< (max ?c (+ ?c ?c)) (+ ?b ?a)) if (< ?c 0)
// (< (max ?c (+ ?c ?c)) (+ ?b ?a)) ==> (< ?c (+ ?b ?a)) if (< ?c 0)
// (< (max ?c ?b) ?a) ==> (< (max ?c ?b) (max ?a (+ ?c ?b))) if (< ?c 0)
// (< (max ?c ?b) (max ?a (+ ?c ?b))) ==> (< (max ?c ?b) ?a) if (< ?c 0)
// (< (max ?c ?b) ?a) ==> (< (max ?c ?b) (max ?a (+ ?c ?a))) if (< ?c 0)
// (< (max ?c ?b) (max ?a (+ ?c ?a))) ==> (< (max ?c ?b) ?a) if (< ?c 0)
// (< (+ ?c ?b) ?a) ==> (< (+ ?c ?b) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?c ?b) (max ?a (+ ?b ?a))) ==> (< (+ ?c ?b) ?a) if (< ?b 0)
// (< ?c (max ?b ?a)) ==> (< (max ?c (+ ?c ?c)) (max ?b ?a)) if (< ?c 0)
// (< (max ?c (+ ?c ?c)) (max ?b ?a)) ==> (< ?c (max ?b ?a)) if (< ?c 0)
// (< ?c (max ?b ?a)) ==> (< (max ?c (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?c (+ ?b ?b)) (max ?b ?a)) ==> (< ?c (max ?b ?a)) if (< ?b 0)
// (< ?c (max ?b ?a)) ==> (< (max ?c (+ ?b ?a)) (max ?b ?a)) if (< ?b 0)
// (< (max ?c (+ ?b ?a)) (max ?b ?a)) ==> (< ?c (max ?b ?a)) if (< ?b 0)
// (< (+ ?a (max ?c ?b)) ?a) ==> (< (max ?a (+ ?a ?a)) ?a) if (< 0 ?b)
// (< (+ ?c (max ?a ?b)) ?b) ==> (< (max ?a (+ ?b ?b)) ?a) if (< 0 ?c)
// (< (+ ?c (max ?b ?a)) ?a) ==> (< (max ?a (+ ?b ?a)) ?a) if (< 0 ?c)
// (< (+ ?a (max ?c ?b)) ?c) ==> (< (max ?a (+ ?c ?b)) ?a) if (< 0 ?a)
// (< (max ?a (+ ?c ?b)) ?a) ==> (< (+ ?a (max ?c ?b)) ?c) if (< 0 ?a)
// (< ?c (+ ?b ?a)) ==> (< (max ?c ?b) (max ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?c ?b) (max ?c (+ ?b ?a))) ==> (< ?c (+ ?b ?a)) if (< 0 ?a)
// (< (max ?c (+ ?b ?a)) (max ?b (+ ?b ?a))) ==> 0 if (< 0 ?a)
// (< (+ ?c ?b) ?a) ==> (< (+ ?c (max ?b ?a)) ?a) if (< ?c 0)
// (< (+ ?c (max ?b ?a)) ?a) ==> (< (+ ?c ?b) ?a) if (< ?c 0)
// (< (+ ?a (max ?c ?b)) ?a) ==> 0 if (< 0 ?b)
// (< (max ?c (+ ?a ?b)) ?a) ==> 0 if (< 0 ?b)
// (< ?b (max ?c (+ ?b ?a))) ==> 1 if (< 0 ?a)
// (< (max ?a (+ ?c ?b)) ?a) ==> 0 if (< 0 ?a)
// (< ?c (+ ?c (max ?b ?a))) ==> 1 if (< 0 ?a)
// (< ?b (+ ?c (max ?b ?a))) ==> 1 if (< 0 ?c)
// (< (max ?a (+ ?c ?b)) ?a) ==> 0 if (< 0 ?b)
...
// (< (max ?d (max ?b ?c)) (max ?c (+ ?a ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?a 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?a ?d))) if (< ?a 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?a ?d))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?a ?c))) if (< ?a 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?a ?c))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?b (max ?d ?c)) (max ?b (+ ?b ?a))) ==> (< (max ?b (max ?d ?c)) (+ ?b (max ?d ?a))) if (< ?b 0)
// (< (max ?b (max ?d ?c)) (+ ?b (max ?d ?a))) ==> (< (max ?b (max ?d ?c)) (max ?b (+ ?b ?a))) if (< ?b 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?d ?b))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?d ?b))) if (< ?b 0)
// (< (max ?a (+ ?b ?d)) (max ?c (+ ?b ?c))) ==> (< (max ?a (+ ?b ?d)) (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?b ?d)) (max ?c (+ ?b ?a))) ==> (< (max ?a (+ ?b ?d)) (max ?c (+ ?b ?c))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?d (+ ?b ?b))) if (< ?a 0)
// (< (max ?b (max ?a ?d)) (max ?c (+ ?a ?a))) ==> (< (max ?b (max ?a ?d)) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?b (max ?a ?d)) (max ?c (+ ?b ?a))) ==> (< (max ?b (max ?a ?d)) (max ?c (+ ?a ?a))) if (< ?a 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (max ?d (+ ?b ?c))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (+ ?a (max ?d ?a))) ==> (< (max ?d (max ?c ?b)) (max ?b (+ ?a ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (max ?b (+ ?a ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?a (max ?d ?a))) if (< ?a 0)
// (< (max ?d (max ?b ?c)) (max ?d (+ ?a ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?d (+ ?a ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?b (+ ?a ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (max ?b (+ ?a ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) ==> (< (max ?c (max ?b ?d)) (max ?a (+ ?b ?b))) if (< ?b 0)
// (< (max ?c (max ?b ?d)) (max ?a (+ ?b ?b))) ==> (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?c (+ ?b ?b))) if (< ?a 0)
// (< (max ?b (+ ?d ?b)) (max ?c (+ ?b ?a))) ==> (< (max ?b (+ ?d ?b)) (max ?c (+ ?d ?b))) if (< ?a 0)
// (< (max ?c (max ?b ?d)) (max ?a (+ ?b ?a))) ==> (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) ==> (< (max ?c (max ?b ?d)) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (max ?c (max ?b ?a)) (+ ?a (max ?b ?d))) ==> (< (max ?c (max ?b ?a)) (max ?a (+ ?b ?a))) if (< ?d 0)
// (< (max ?d (max ?c ?b)) (max ?c (max ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?c (max ?b ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (max ?c (max ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?d ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?d ?a))) ==> (< (max ?d (max ?c ?b)) (max ?c (max ?b ?a))) if (< ?a 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (max ?b (+ ?c ?a))) if (< ?b 0)
// (< (max ?b (max ?c ?d)) (max ?b (+ ?c ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c (max ?b ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?c (max ?b ?d)) (max ?d (+ ?c ?b))) if (< ?a 0)
// (< (max ?b (max ?c ?d)) (max ?d (+ ?c ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (max ?d (+ ?c ?a))) if (< ?b 0)
// (< (max ?a (max ?d ?c)) (max ?b (+ ?a ?a))) ==> (< (max ?a (max ?d ?c)) (max ?b (+ ?a ?d))) if (< ?a 0)
// (< (max ?a (max ?d ?c)) (max ?b (+ ?a ?d))) ==> (< (max ?a (max ?d ?c)) (max ?b (+ ?a ?a))) if (< ?a 0)
// (< (max ?d (+ ?b ?c)) (max ?b (+ ?b ?a))) ==> (< (max ?d (+ ?b ?c)) (max ?b (+ ?b ?c))) if (< ?a 0)
// (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) ==> (< (max ?c (max ?b ?d)) (max ?a (+ ?c ?a))) if (< ?c 0)
// (< (max ?c (max ?b ?d)) (max ?a (+ ?c ?a))) ==> (< (max ?c (max ?b ?d)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?d ?c))) if (< ?c 0)
// (< (max ?d (+ ?b ?a)) (max ?c (+ ?d ?c))) ==> (< (max ?d (+ ?b ?a)) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?b (+ ?c ?c)) (max ?b (+ ?a ?d))) ==> (< (+ ?b (+ ?c ?a)) (+ ?b (max ?b ?a))) if (< ?c 0)
// (< (max ?b (max ?a ?d)) (max ?c (+ ?b ?a))) ==> (< (max ?b (max ?a ?d)) (max ?c (+ ?a ?c))) if (< ?a 0)
// (< (max ?b (max ?a ?d)) (max ?c (+ ?a ?c))) ==> (< (max ?b (max ?a ?d)) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?b (max ?c ?d)) (max ?c (+ ?c ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (max ?c (+ ?c ?a))) if (< ?b 0)
// (< (max ?b (max ?c ?d)) (max ?b (+ ?c ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (max ?b (+ ?c ?a))) if (< ?c 0)
// (< (max ?d (max ?b ?c)) (max ?b (+ ?b ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?b (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?d ?c)) (+ ?c (max ?b ?a))) ==> (< (+ ?b (+ ?d ?d)) (max ?d (+ ?b ?b))) if (< ?d 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?d (+ ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (max ?d (+ ?b ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?c ?b)) (+ ?c (max ?b ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?b (max ?c ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (+ ?b (max ?c ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?c (max ?b ?a))) if (< ?a 0)
// (< (max ?d (max ?b ?c)) (max ?c (+ ?a ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (max ?c (+ ?a ?a))) if (< ?b 0)
// (< (max ?b (max ?d ?c)) (+ ?a (max ?c ?a))) ==> (< (max ?b (max ?d ?c)) (max ?b (+ ?a ?a))) if (< ?a 0)
// (< (max ?b (max ?d ?c)) (max ?b (+ ?a ?a))) ==> (< (max ?b (max ?d ?c)) (+ ?a (max ?c ?a))) if (< ?a 0)
// (< (max ?c (max ?d ?b)) (+ ?b (max ?c ?a))) ==> (< (max ?c (max ?d ?b)) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?c (max ?d ?b)) (max ?c (+ ?b ?a))) ==> (< (max ?c (max ?d ?b)) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?c (max ?d ?b)) (+ ?c (max ?c ?a))) ==> (< (max ?c (max ?d ?b)) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?c (max ?d ?b)) (+ ?c (max ?b ?a))) ==> (< (max ?c (max ?d ?b)) (+ ?c (max ?c ?a))) if (< ?c 0)
// (< (max ?d (max ?c ?b)) (max ?b (+ ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) if (< 0 ?b)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?b (+ ?b ?a))) if (< 0 ?b)
// (< (+ ?c ?b) (max ?c (+ ?a ?d))) ==> (< (+ ?c (+ ?b ?a)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?c ?b)) (+ ?b ?a)) ==> (< (max ?d (max ?c ?b)) (+ ?b (max ?c ?a))) if (< ?c 0)
// (< (max ?d (max ?c ?b)) (+ ?b (max ?c ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?b ?a)) if (< ?c 0)
// (< (max ?c (+ ?d ?b)) (+ ?c ?a)) ==> (< (max ?c (+ ?d ?b)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?c (+ ?d ?b)) (+ ?c (max ?b ?a))) ==> (< (max ?c (+ ?d ?b)) (+ ?c ?a)) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?a ?a)) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?a 0)
// (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a ?a)) if (< ?a 0)
// (< (max ?b (max ?c ?d)) (+ ?c ?a)) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c ?a)) if (< ?c 0)
// (< (+ ?b (max ?c ?d)) (max ?b ?a)) ==> (< (+ ?c (+ ?d ?b)) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (+ ?c (+ ?d ?b)) (+ ?c (max ?b ?a))) ==> (< (+ ?b (max ?c ?d)) (max ?b ?a)) if (< ?c 0)
// (< (max ?b (max ?c ?d)) (+ ?c ?a)) ==> (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?b (max ?c ?d)) (+ ?c (max ?b ?a))) ==> (< (max ?b (max ?c ?d)) (+ ?c ?a)) if (< ?b 0)
// (< (max ?d (max ?c ?b)) (max ?b ?a)) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?c ?b))) if (< ?c 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?c ?b))) ==> (< (max ?d (max ?c ?b)) (max ?b ?a)) if (< ?c 0)
// (< (max ?b (+ ?d ?c)) (+ ?b ?a)) ==> (< (max ?b (+ ?d ?c)) (+ ?b (max ?b ?a))) if (< ?b 0)
// (< (max ?b (+ ?d ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?b (+ ?d ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (max ?b (max ?c ?a)) (+ ?a (max ?b ?d))) ==> (< (max ?b (max ?c ?a)) (+ ?b ?a)) if (< ?d 0)
// (< (max ?d (max ?b ?c)) (+ ?a ?a)) ==> (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?a (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?a ?a)) if (< ?b 0)
// (< (+ ?c ?d) (max ?c (max ?b ?a))) ==> (< (+ ?c (max ?d ?b)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (+ ?c (max ?d ?b)) (max ?c (max ?b ?a))) ==> (< (+ ?c ?d) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?b ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?b ?b)) if (< ?a 0)
// (< (max ?d (max ?b ?c)) (+ ?b ?a)) ==> (< (max ?d (max ?b ?c)) (+ ?b (max ?c ?a))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (+ ?b (max ?c ?a))) ==> (< (max ?d (max ?b ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (+ ?d ?d) (max ?c (+ ?b ?a))) ==> (< (+ ?d (max ?d ?c)) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?d (max ?d ?c)) (max ?c (+ ?b ?a))) ==> (< (+ ?d ?d) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?d ?d) (max ?c (max ?b ?a))) ==> (< (+ ?d (max ?d ?c)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (+ ?d (max ?d ?c)) (max ?c (max ?b ?a))) ==> (< (+ ?d ?d) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (max ?b ?c)) (max ?b ?a)) ==> (< (max ?d (max ?b ?c)) (max ?a (+ ?b ?b))) if (< ?b 0)
// (< (max ?d (max ?b ?c)) (max ?a (+ ?b ?b))) ==> (< (max ?d (max ?b ?c)) (max ?b ?a)) if (< ?b 0)
// (< (+ ?b (+ ?a ?d)) (+ ?d (max ?a ?c))) ==> (< (+ ?a (+ ?b ?b)) (max ?b ?a)) if (< ?b 0)
// (< (max ?d (+ ?b ?c)) (+ ?b ?a)) ==> (< (max ?d (+ ?b ?c)) (+ ?b (max ?d ?a))) if (< ?b 0)
// (< (max ?d (+ ?b ?c)) (+ ?b (max ?d ?a))) ==> (< (max ?d (+ ?b ?c)) (+ ?b ?a)) if (< ?b 0)
// (< (max ?d (max ?c ?b)) (max ?b ?a)) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) if (< ?a 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?b ?a))) ==> (< (max ?d (max ?c ?b)) (max ?b ?a)) if (< ?a 0)
// (< (max ?d (+ ?c ?c)) (max ?b ?a)) ==> (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?c ?c)) (max ?b ?a)) if (< 0 ?a)
// (< (+ ?d ?c) (+ ?b (+ ?a ?a))) ==> (< (max ?b (+ ?d ?c)) (+ ?b (+ ?a ?a))) if (< 0 ?a)
// (< (max ?b (+ ?d ?c)) (+ ?b (+ ?a ?a))) ==> (< (+ ?d ?c) (+ ?b (+ ?a ?a))) if (< 0 ?a)
// (< (+ ?d (max ?d ?c)) (max ?b ?a)) ==> (< (+ ?d (max ?d ?c)) (max ?d (max ?b ?a))) if (< 0 ?a)
// (< (+ ?d (max ?d ?c)) (max ?d (max ?b ?a))) ==> (< (+ ?d (max ?d ?c)) (max ?b ?a)) if (< 0 ?a)
// (< (max ?d ?c) (+ ?b (+ ?a ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?b (+ ?a ?a))) if (< 0 ?a)
// (< (max ?d (max ?c ?b)) (+ ?b (+ ?a ?a))) ==> (< (max ?d ?c) (+ ?b (+ ?a ?a))) if (< 0 ?a)
// (< (+ ?d (+ ?b ?c)) (+ ?b ?a)) ==> (< (+ ?d (+ ?b ?c)) (+ ?b (max ?d ?a))) if (< 0 ?c)
// (< (+ ?d (+ ?b ?c)) (+ ?b (max ?d ?a))) ==> (< (+ ?d (+ ?b ?c)) (+ ?b ?a)) if (< 0 ?c)
// (< (+ ?d ?c) (max ?b (+ ?a ?a))) ==> (< (max ?a (+ ?d ?c)) (max ?b (+ ?a ?a))) if (< 0 ?b)
// (< (max ?a (+ ?d ?c)) (max ?b (+ ?a ?a))) ==> (< (+ ?d ?c) (max ?b (+ ?a ?a))) if (< 0 ?b)
// (< (max ?d (+ ?c ?c)) (max ?b ?a)) ==> (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) if (< 0 ?b)
// (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?c ?c)) (max ?b ?a)) if (< 0 ?b)
// (< (+ ?d ?d) (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?d)) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (max ?d (+ ?d ?d)) (max ?c (max ?b ?a))) ==> (< (+ ?d ?d) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (+ ?c ?d) (+ ?c (+ ?b ?a))) ==> (< (+ ?c (max ?d ?b)) (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?c (max ?d ?b)) (+ ?c (+ ?b ?a))) ==> (< (+ ?c ?d) (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d (+ ?c ?b)) (+ ?a ?a)) ==> (< (max ?d (+ ?c ?b)) (max ?a (+ ?a ?a))) if (< 0 ?d)
// (< (max ?d (+ ?c ?b)) (max ?a (+ ?a ?a))) ==> (< (max ?d (+ ?c ?b)) (+ ?a ?a)) if (< 0 ?d)
// (< (+ ?c (max ?d ?c)) (max ?b ?a)) ==> (< (+ ?c (max ?d ?c)) (max ?c (max ?b ?a))) if (< 0 ?a)
// (< (+ ?c (max ?d ?c)) (max ?c (max ?b ?a))) ==> (< (+ ?c (max ?d ?c)) (max ?b ?a)) if (< 0 ?a)
// (< (max ?c ?b) (+ ?b (max ?a ?d))) ==> (< (max ?c ?b) (max ?b (+ ?b ?a))) if (< ?d 0)
// (< (+ ?c ?b) (max ?b (+ ?a ?d))) ==> (< (+ ?b (+ ?c ?c)) (max ?b ?a)) if (< ?c 0)
// (< (max ?b ?c) (+ ?b (max ?a ?d))) ==> (< (max ?b ?c) (max ?b (+ ?b ?a))) if (< ?d 0)
// (< (max ?c (+ ?d ?c)) (max ?b ?a)) ==> (< (+ ?d ?c) (+ ?d (max ?b ?a))) if (< ?d 0)
// (< (+ ?d ?c) (+ ?d (max ?b ?a))) ==> (< (max ?c (+ ?d ?c)) (max ?b ?a)) if (< ?d 0)
// (< (max ?b ?d) (+ ?c (max ?b ?a))) ==> (< (max ?b ?d) (+ ?c (max ?d ?a))) if (< ?c 0)
// (< (max ?b ?d) (+ ?c (max ?d ?a))) ==> (< (max ?b ?d) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?c ?d) (max ?c (+ ?b ?a))) ==> (< (max ?c ?d) (+ ?a (max ?d ?b))) if (< ?a 0)
// (< (max ?c ?d) (+ ?a (max ?d ?b))) ==> (< (max ?c ?d) (max ?c (+ ?b ?a))) if (< ?a 0)
// (< (max ?c ?b) (+ ?b (max ?a ?d))) ==> (< (max ?c ?b) (max ?c (+ ?b ?a))) if (< ?d 0)
// (< (+ ?c ?d) (max ?c (+ ?b ?a))) ==> (< (+ ?c ?d) (max ?d (+ ?c ?c))) if (< ?d 0)
// (< (+ ?b ?c) (max ?b (max ?a ?d))) ==> (< (+ ?b (+ ?c ?c)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?c ?b) (max ?b (max ?a ?d))) ==> (< (+ ?b (+ ?c ?c)) (max ?b ?a)) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (max ?b ?a)) ==> (< (max ?d (+ ?c ?b)) (max ?b ?a)) if (< ?c 0)
// (< (max ?d (+ ?c ?b)) (max ?b ?a)) ==> (< (max ?d (+ ?d ?c)) (max ?b ?a)) if (< ?c 0)
// (< (+ ?b ?a) (max ?b (max ?d ?c))) ==> (< (+ ?b (+ ?a ?a)) (max ?b ?a)) if (< ?a 0)
// (< (+ ?d ?c) (+ ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (max ?b ?a)) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (max ?b ?a)) ==> (< (+ ?d ?c) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (+ ?b ?a)) ==> (< (+ ?d ?c) (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< (+ ?d ?c) (+ ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (+ ?b ?a)) if (< ?c 0)
// (< (max ?b (max ?a ?c)) (+ ?d (max ?a ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?d 0)
// (< ?d (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?d)) (max ?c (max ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?d)) (max ?c (max ?b ?a))) ==> (< ?d (max ?c (max ?b ?a))) if (< ?d 0)
// (< (+ ?a (+ ?b ?d)) (max ?d (+ ?d ?c))) ==> (< (+ ?b (+ ?a ?a)) ?a) if (< ?c 0)
// (< (max ?a (max ?d ?c)) (+ ?c (+ ?b ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?d (max ?c ?b)) ?a) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?c ?b))) if (< ?c 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?c ?b))) ==> (< (max ?d (max ?c ?b)) ?a) if (< ?c 0)
// (< ?d (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?b)) (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?d (+ ?d ?b)) (max ?c (+ ?b ?a))) ==> (< ?d (max ?c (+ ?b ?a))) if (< ?b 0)
// (< (max ?d (+ ?c ?b)) ?a) ==> (< (max ?d (+ ?c ?b)) (max ?a (+ ?c ?a))) if (< ?c 0)
// (< (max ?d (+ ?c ?b)) (max ?a (+ ?c ?a))) ==> (< (max ?d (+ ?c ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?b ?c)) (+ ?d (max ?a ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?d 0)
// (< (max ?a (+ ?d ?c)) (+ ?a (+ ?b ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (+ ?d (max ?a ?b)) (max ?d (+ ?d ?c))) ==> (< (+ ?a (max ?a ?b)) ?a) if (< ?c 0)
// (< (+ ?d (max ?b ?a)) (+ ?b (+ ?d ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?c 0)
// (< ?d (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (max ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?c)) (max ?c (+ ?b ?a))) ==> (< ?d (max ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?a (max ?b ?d)) (max ?a (+ ?d ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?b ?c)) (+ ?d (max ?b ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?d 0)
// (< ?d (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?c ?c)) (max ?c (max ?b ?a))) ==> (< ?d (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?a (max ?c ?d)) (max ?d (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< ?d (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (max ?c (+ ?b ?a))) ==> (< ?d (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?c (+ ?a ?d)) (+ ?c (+ ?b ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?d)) (+ ?c (max ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?d)) (+ ?c (max ?b ?a))) ==> (< ?d (+ ?c (max ?b ?a))) if (< ?d 0)
// (< (max ?a (max ?c ?d)) (+ ?c (+ ?b ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?a (+ ?b ?d)) (+ ?b (+ ?d ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (+ ?d (max ?b ?a)) (+ ?a (+ ?d ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?c 0)
// (< (max ?b (max ?a ?d)) (+ ?d (+ ?c ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?c 0)
// (< ?d (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?c ?c)) (max ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?c ?c)) (max ?c (+ ?b ?a))) ==> (< ?d (max ?c (+ ?b ?a))) if (< ?c 0)
// (< ?d (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?c ?b)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?c ?b)) (max ?c (max ?b ?a))) ==> (< ?d (max ?c (max ?b ?a))) if (< ?c 0)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?b)) (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?d (+ ?d ?b)) (+ ?c (max ?b ?a))) ==> (< ?d (+ ?c (max ?b ?a))) if (< ?b 0)
// (< (max ?a (+ ?d ?c)) (+ ?d (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?b (max ?a ?c)) (+ ?d (max ?b ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?d 0)
// (< (+ ?b (+ ?a ?d)) (+ ?d (max ?b ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< (max ?a (max ?b ?d)) (+ ?d (+ ?c ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?c ?b)) (max ?a (+ ?b ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< ?d (+ ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (+ ?c (+ ?b ?a))) ==> (< ?d (+ ?c (+ ?b ?a))) if (< ?c 0)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (+ ?c (max ?b ?a))) ==> (< ?d (+ ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?a (max ?b ?d)) (max ?b (+ ?d ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?d ?c)) (max ?a (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?d (+ ?c ?b)) ?a) ==> (< (max ?d (+ ?c ?b)) (max ?a (+ ?d ?a))) if (< ?d 0)
// (< (max ?d (+ ?c ?b)) (max ?a (+ ?d ?a))) ==> (< (max ?d (+ ?c ?b)) ?a) if (< ?d 0)
// (< (+ ?d (+ ?c ?b)) ?a) ==> (< (+ ?d (+ ?c ?b)) (max ?a (+ ?c ?a))) if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) (max ?a (+ ?c ?a))) ==> (< (+ ?d (+ ?c ?b)) ?a) if (< ?c 0)
// (< (+ ?b (+ ?d ?c)) ?a) ==> (< (+ ?b (+ ?d ?c)) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?b (+ ?d ?c)) (max ?a (+ ?b ?a))) ==> (< (+ ?b (+ ?d ?c)) ?a) if (< ?b 0)
// (< (+ ?d (max ?a ?b)) (+ ?a (+ ?d ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (max ?b (max ?a ?d)) (max ?b (+ ?d ?c))) ==> (< (max ?a (+ ?b ?a)) ?a) if (< ?c 0)
// (< (+ ?d (max ?c ?b)) ?a) ==> (< (+ ?d (max ?c ?b)) (max ?a (+ ?d ?a))) if (< ?d 0)
// (< (+ ?d (max ?c ?b)) (max ?a (+ ?d ?a))) ==> (< (+ ?d (max ?c ?b)) ?a) if (< ?d 0)
// (< (max ?c (max ?b ?a)) (max ?a (+ ?b ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (max ?c ?d)) (max ?a (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (+ ?b (+ ?a ?d)) (+ ?b (max ?d ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?a 0)
// (< ?d (+ ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?d)) (+ ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?d)) (+ ?c (+ ?b ?a))) ==> (< ?d (+ ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?c (max ?b ?a)) (+ ?a (+ ?d ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (max ?c ?b)) (+ ?d (max ?c ?b))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (+ ?c (+ ?b ?a)) (+ ?a (max ?b ?d))) ==> (< (+ ?c ?b) (max ?b ?a)) if (< ?c 0)
// (< (max ?a (max ?b ?d)) (max ?d (+ ?d ?c))) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?b ?c)) (+ ?d (max ?a ?c))) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?d 0)
// (< (+ ?b (+ ?d ?c)) (+ ?c (max ?b ?a))) ==> (< (+ ?b ?d) (max ?b ?c)) if (< ?d 0)
// (< (+ ?d (max ?c ?b)) ?a) ==> (< (+ ?d (max ?c ?b)) (max ?a (+ ?c ?a))) if (< ?c 0)
// (< (+ ?d (max ?c ?b)) (max ?a (+ ?c ?a))) ==> (< (+ ?d (max ?c ?b)) ?a) if (< ?c 0)
// (< ?d (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?d (+ ?d ?c)) (max ?c (max ?b ?a))) ==> (< ?d (max ?c (max ?b ?a))) if (< ?c 0)
// (< (max ?a (+ ?c ?b)) (+ ?a (+ ?d ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (+ ?d (max ?c ?b)) ?a) ==> (< (+ ?d (max ?c ?b)) (max ?a (+ ?b ?a))) if (< ?b 0)
// (< (+ ?d (max ?c ?b)) (max ?a (+ ?b ?a))) ==> (< (+ ?d (max ?c ?b)) ?a) if (< ?b 0)
// (< ?d (max ?c (+ ?b ?a))) ==> (< (max ?d (+ ?d ?d)) (max ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?d)) (max ?c (+ ?b ?a))) ==> (< ?d (max ?c (+ ?b ?a))) if (< ?d 0)
// (< (max ?b (+ ?a ?c)) (+ ?b (+ ?d ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?d (max ?c ?b)) ?a) ==> (< (max ?d (max ?c ?b)) (max ?a (+ ?d ?a))) if (< ?d 0)
// (< (max ?d (max ?c ?b)) (max ?a (+ ?d ?a))) ==> (< (max ?d (max ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (max ?c ?b)) (max ?b (+ ?b ?d))) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< ?d (max ?c (max ?b ?a))) ==> (< (max ?d (+ ?d ?c)) (max ?c (max ?b ?a))) if (< ?d 0)
// (< (max ?d (+ ?d ?c)) (max ?c (max ?b ?a))) ==> (< ?d (max ?c (max ?b ?a))) if (< ?d 0)
// (< (+ ?c (max ?a ?d)) (+ ?d (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?b (max ?a ?d)) (+ ?a (+ ?c ?c))) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (+ ?d (max ?b ?a)) (+ ?a (+ ?d ?c))) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?d ?c)) (max ?d (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?a (+ ?b ?d)) (+ ?b (+ ?d ?c))) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (max ?a (max ?b ?d)) (max ?d (+ ?d ?c))) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (+ ?c (max ?a ?d)) (+ ?a (+ ?c ?b))) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?d (max ?c ?b)) (+ ?b ?a)) ==> (< (max ?d ?c) (max ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d ?c) (max ?c (+ ?b ?a))) ==> (< (max ?d (max ?c ?b)) (+ ?b ?a)) if (< 0 ?a)
// (< ?d (+ ?c (+ ?b ?a))) ==> (< (max ?d (+ ?c ?b)) (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d (+ ?c ?b)) (+ ?c (+ ?b ?a))) ==> (< ?d (+ ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (max ?d (max ?c ?b)) (max ?c (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d (max ?c ?b)) (max ?c (+ ?b ?a))) ==> (< (max ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< (max ?c (+ ?b ?a)) (+ ?c ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (+ ?c ?b)) (+ ?a ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?c (max ?b ?a)) (+ ?b ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (max ?c ?b)) (+ ?b ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?b (+ ?a ?c)) (+ ?b ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (+ ?c ?b) (max ?b (+ ?a ?d))) ==> (< (+ ?c ?b) (max ?b ?a)) if (< ?c 0)
// (< (max ?a (max ?c ?b)) (+ ?c ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?a (max ?d ?c)) (+ ?a ?b)) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?c ?b) (+ ?b (max ?a ?d))) ==> (< (max ?c ?b) (+ ?b ?a)) if (< ?d 0)
// (< (max ?c (max ?b ?a)) (+ ?a ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (max ?d ?c) (+ ?a (max ?c ?b))) if (< ?a 0)
// (< (max ?d ?c) (+ ?a (max ?c ?b))) ==> (< (max ?d ?c) (+ ?b ?a)) if (< ?a 0)
// (< (max ?a (+ ?d ?c)) (+ ?a ?b)) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?a (max ?c ?b)) (+ ?a ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (max ?c (max ?b ?a)) (+ ?c ?d)) ==> (< (max ?a (+ ?c ?b)) ?a) if (< ?d 0)
// (< (+ ?b ?a) (max ?a (+ ?d ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?b 0)
// (< (+ ?d ?c) (max ?c (max ?b ?a))) ==> (< (+ ?d ?d) (max ?d ?c)) if (< ?d 0)
// (< (max ?c (+ ?a ?d)) (+ ?c ?b)) ==> (< (max ?a (+ ?a ?a)) ?a) if (< ?b 0)
// (< (max ?a (+ ?b ?d)) (+ ?a ?c)) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (+ ?d ?c) (max ?b ?a)) ==> (< (+ ?d (max ?c ?b)) (max ?b ?a)) if (< ?d 0)
// (< (+ ?d (max ?c ?b)) (max ?b ?a)) ==> (< (+ ?d ?c) (max ?b ?a)) if (< ?d 0)
// (< (max ?a (max ?b ?d)) (+ ?d ?c)) ==> (< (max ?a (+ ?b ?b)) ?a) if (< ?c 0)
// (< (max ?d (+ ?a ?b)) (+ ?d ?c)) ==> (< (max ?a (+ ?a ?b)) ?a) if (< ?c 0)
// (< (+ ?b ?a) (max ?a (max ?d ?c))) ==> (< (+ ?b ?a) (max ?b ?a)) if (< ?b 0)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d ?c) (+ ?c (max ?b ?a))) if (< 0 ?b)
// (< (max ?d ?c) (+ ?c (max ?b ?a))) ==> (< ?d (+ ?c (max ?b ?a))) if (< 0 ?b)
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (max ?d ?c) (max ?b (+ ?b ?a))) if (< 0 ?a)
// (< (max ?d ?c) (max ?b (+ ?b ?a))) ==> (< (max ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< (max ?d (+ ?b ?c)) ?a) ==> (< (max ?d (+ ?b ?c)) (max ?b ?a)) if (< 0 ?c)
// (< (max ?d (+ ?b ?c)) (max ?b ?a)) ==> (< (max ?d (+ ?b ?c)) ?a) if (< 0 ?c)
// (< (+ ?d (max ?c ?b)) ?a) ==> (< (+ ?d (max ?c ?b)) (max ?c ?a)) if (< 0 ?d)
// (< (+ ?d (max ?c ?b)) (max ?c ?a)) ==> (< (+ ?d (max ?c ?b)) ?a) if (< 0 ?d)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d ?c) (+ ?c (max ?b ?a))) if (< 0 ?a)
// (< (max ?d ?c) (+ ?c (max ?b ?a))) ==> (< ?d (+ ?c (max ?b ?a))) if (< 0 ?a)
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (max ?d (max ?c ?b)) (+ ?b ?a)) if (< 0 ?a)
// (< (max ?d (max ?c ?b)) (+ ?b ?a)) ==> (< (max ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< (+ ?d ?c) (+ ?b ?a)) ==> (< (+ ?d ?c) (max ?b (+ ?b ?a))) if (< 0 ?a)
// (< (+ ?d ?c) (max ?b (+ ?b ?a))) ==> (< (+ ?d ?c) (+ ?b ?a)) if (< 0 ?a)
// (< ?d (+ ?c (max ?b ?a))) ==> (< (max ?d ?b) (+ ?c (max ?b ?a))) if (< 0 ?c)
...
// (< (+ ?d (max ?c ?b)) (max ?d ?a)) ==> (< (+ ?d (max ?c ?b)) ?a) if (< 0 ?b)
// (< (max ?d ?c) (+ ?b ?a)) ==> (< (max ?d ?c) (max ?a (+ ?b ?a))) if (< 0 ?b)
// (< (max ?d ?c) (max ?a (+ ?b ?a))) ==> (< (max ?d ?c) (+ ?b ?a)) if (< 0 ?b)
...
// (< (+ ?b (+ ?d ?a)) (max ?c (+ ?b ?a))) ==> 1 if (< ?d 0)
// (< (+ ?c (max ?d ?b)) (+ ?c (+ ?b ?a))) ==> 0 if (< ?a 0)
// (< (+ ?d (max ?c ?b)) (max ?c (max ?b ?a))) ==> 1 if (< ?d 0)
// (< (max ?d (+ ?b ?c)) (+ ?c (+ ?b ?a))) ==> 0 if (< ?a 0)
// (< (+ ?c (+ ?d ?d)) (max ?c (+ ?b ?a))) ==> 1 if (< ?d 0)
// (< (max ?b (max ?d ?c)) (max ?b (+ ?b ?a))) ==> 0 if (< ?a 0)
// (< (max ?d (max ?b ?a)) (+ ?c (max ?b ?a))) ==> 0 if (< ?c 0)
// (< (+ ?d (+ ?c ?b)) (+ ?c (max ?b ?a))) ==> 1 if (< ?d 0)
// (< (max ?b (max ?c ?d)) (max ?c (+ ?b ?a))) ==> 0 if (< ?a 0)
// (< (+ ?c (+ ?d ?d)) (max ?c (max ?b ?a))) ==> 1 if (< ?d 0)
// (< (+ ?c ?d) (max ?c (max ?b ?a))) ==> 1 if (< ?d 0)
